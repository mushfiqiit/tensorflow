...
cond.end:                                         ; preds = %cond.false, %cond.true
  %cond = phi i64 [ %26, %cond.true ], [ 16, %cond.false ]
...
if.end54:                                         ; preds = %if.end53, %if.end47
  %40 = load %struct.TF_Tensor*, %struct.TF_Tensor** %t, align 8
  call void @TF_DeleteTensor(%struct.TF_Tensor* %40)
  %41 = load i8*, i8** %base, align 8
  call void @free(i8* %41) #5
  store i32 0, i32* %retval, align 4
  br label %return

return:                                           ; preds = %if.end54, %if.end42

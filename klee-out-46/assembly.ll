...
land.end27:                                       ; preds = %land.rhs25, %lor.end
  ...
  call void @klee_make_symbolic(i8* %26, i64 6, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.4, i64 0, i64 0))
  %27 = load i32, i32* %dtype, align 4
  %arraydecay33 = getelementptr inbounds [3 x i64], [3 x i64]* %dims, i64 0, i64 0
  %28 = load i8*, i8** %data, align 8
  %29 = load i64, i64* %len, align 8
  %call34 = call %struct.TF_Tensor* @TF_NewTensor(i32 %27, i64* %arraydecay33, i32 2, i8* %28, i64 %29, void (i8*, i64, i8*)* @_ZL17dummy_deallocatorPvmS_, i8* null)
  store %struct.TF_Tensor* %call34, %struct.TF_Tensor** %t, align 8
  %30 = load %struct.TF_Tensor*, %struct.TF_Tensor** %t, align 8
  %cmp35 = icmp eq %struct.TF_Tensor* %30, null
  br i1 %cmp35, label %if.then, label %if.end42

if.then:                                          ; preds = %land.end27
  %arrayidx36 = getelementptr inbounds [3 x i64], [3 x i64]* %dims, i64 0, i64 0
  %31 = load i64, i64* %arrayidx36, align 16
  %cmp37 = icmp eq i64 %31, 0
  br i1 %cmp37, label %if.then41, label %lor.lhs.false38

lor.lhs.false38:                                  ; preds = %if.then
  %arrayidx39 = getelementptr inbounds [3 x i64], [3 x i64]* %dims, i64 0, i64 1
  %32 = load i64, i64* %arrayidx39, align 8
  %cmp40 = icmp eq i64 %32, 0
  br i1 %cmp40, label %if.then41, label %if.else

if.then41:                                        ; preds = %lor.lhs.false38, %if.then
  br label %if.end
...
if.end42:                                         ; preds = %land.end27
  %33 = load %struct.TF_Tensor*, %struct.TF_Tensor** %t, align 8
  call void @TF_DeleteTensor(%struct.TF_Tensor* %33)
  %34 = load i8*, i8** %base, align 8

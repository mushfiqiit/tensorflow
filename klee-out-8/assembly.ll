...
%"class.google::protobuf::internal::ThreadSafeArena" = type { i64, %"struct.absl::lts_20250127::container_internal::internal_compressed_tuple::Storage.4", %"class.std::ios_base::Init", %"class.absl::lts_20250127::container_internal::CompressedTuple", %"struct.std::atomic.8", i8*, %"class.google::protobuf::internal::SerialArena" }
%"struct.std::atomic.8" = type { %"struct.std::__atomic_base.9" }
%"struct.std::__atomic_base.9" = type { %"class.google::protobuf::internal::ThreadSafeArena::SerialArenaChunk"* }
%"class.google::protobuf::internal::ThreadSafeArena::SerialArenaChunk" = type opaque
%"class.google::protobuf::internal::SerialArena" = type { %"struct.google::protobuf::internal::ArenaStringPtr", i8*, i8*, %"class.google::protobuf::internal::cleanup::ChunkList", %"struct.std::atomic.12", %"struct.absl::lts_20250127::container_internal::internal_compressed_tuple::CompressedTupleImpl", %"struct.std::atomic.16", %"struct.absl::lts_20250127::container_internal::internal_compressed_tuple::CompressedTupleImpl", %"struct.absl::lts_20250127::container_internal::internal_compressed_tuple::CompressedTupleImpl", %"class.google::protobuf::internal::ThreadSafeArena"*, i8, %"struct.google::protobuf::internal::SerialArena::CachedBlock"** }
...
%"struct.std::__atomic_base.13" = type { %"class.google::protobuf::internal::StringBlock"* }
...
%"struct.std::__atomic_base.17" = type { %"struct.google::protobuf::internal::ArenaBlock"* }
...
%"class.std::function.49" = type { %"class.std::_Function_base", i1 (%"union.std::_Any_data"*, %"class.tensorflow::Variant"**)* }
%"class.std::_Function_base" = type { %"union.std::_Any_data", i1 (%"union.std::_Any_data"*, %"union.std::_Any_data"*, i32)* }
%"union.std::_Any_data" = type { %"union.std::_Nocopy_types" }
%"union.std::_Nocopy_types" = type { { i64, i64 } }
%"class.tensorflow::Variant" = type <{ %union.anon.22, i8, [7 x i8] }>
%union.anon.22 = type { %"class.std::unique_ptr.23", [48 x i8] }
%"class.std::unique_ptr.23" = type { %"struct.std::__uniq_ptr_data.24" }
%"struct.std::__uniq_ptr_data.24" = type { %"class.std::__uniq_ptr_impl.25" }
%"class.std::__uniq_ptr_impl.25" = type { %"class.std::tuple.26" }
%"class.std::tuple.26" = type { %"struct.std::_Tuple_impl.27" }
%"struct.std::_Tuple_impl.27" = type { %struct.TF_Tensor }
%class.anon = type { %"class.std::__cxx11::basic_string" }
%"class.tensorflow::UnaryVariantOpRegistry" = type { %"class.tsl::gtl::FlatMap", %"class.tsl::gtl::FlatMap.18", %"class.tsl::gtl::FlatMap.34", %"class.tsl::gtl::FlatMap.41" }
...
%"class.tsl::gtl::FlatMap.18" = type { %"class.tsl::gtl::internal::FlatRep.19" }
%"class.tsl::gtl::internal::FlatRep.19" = type { %"class.std::ios_base::Init", %"class.std::ios_base::Init", i8, %"struct.tsl::gtl::FlatMap<std::pair<tensorflow::VariantDeviceCopyDirection, tensorflow::TypeIndex>, std::function<absl::lts_20250127::Status (const tensorflow::Variant &, tensorflow::Variant *, std::function<absl::lts_20250127::Status (const tensorflow::Tensor &, tensorflow::Tensor *)>)>, tensorflow::UnaryVariantOpRegistry::PairHash, std::equal_to<std::pair<tensorflow::VariantDeviceCopyDirection, tensorflow::TypeIndex>>>::Bucket"*, %"struct.tsl::gtl::FlatMap<std::pair<tensorflow::VariantDeviceCopyDirection, tensorflow::TypeIndex>, std::function<absl::lts_20250127::Status (const tensorflow::Variant &, tensorflow::Variant *, std::function<absl::lts_20250127::Status (const tensorflow::Tensor &, tensorflow::Tensor *)>)>, tensorflow::UnaryVariantOpRegistry::PairHash, std::equal_to<std::pair<tensorflow::VariantDeviceCopyDirection, tensorflow::TypeIndex>>>::Bucket"*, i64, i64, i64, i64, i64 }
...
%"union.tsl::gtl::FlatMap<tensorflow::UnaryVariantOpRegistry::FuncTuple<tensorflow::VariantBinaryOp>, std::function<absl::lts_20250127::Status (tensorflow::OpKernelContext *, const tensorflow::Variant &, const tensorflow::Variant &, tensorflow::Variant *)>, tensorflow::UnaryVariantOpRegistry::TupleHash, std::equal_to<tensorflow::UnaryVariantOpRegistry::FuncTuple<tensorflow::VariantBinaryOp>>>::Bucket::Storage" = type { %struct.anon.45 }
%struct.anon.45 = type { [8 x %"struct.tensorflow::UnaryVariantOpRegistry::FuncTuple"], [8 x %"class.std::function.47"] }
%"class.std::function.47" = type { %"class.std::_Function_base", void (%"struct.absl::lts_20250127::container_internal::internal_compressed_tuple::Storage.4"*, %"union.std::_Any_data"*, %"class.tensorflow::OpKernelContext"**, %"class.tensorflow::Variant"*, %"class.tensorflow::Variant"*, %"class.tensorflow::Variant"**)* }
%"class.std::type_info" = type { i32 (...)**, i8* }
%"class.absl::lts_20250127::log_internal::LogMessageFatal" = type { %"class.absl::lts_20250127::log_internal::LogMessage" }
%"class.absl::lts_20250127::log_internal::LogMessage" = type { %"class.google::protobuf::internal::CachedSize", %"class.std::unique_ptr" }
%"class.std::unique_ptr" = type { %"struct.std::__uniq_ptr_data" }
%"struct.std::__uniq_ptr_data" = type { %"class.std::__uniq_ptr_impl" }
%"class.std::__uniq_ptr_impl" = type { %"class.std::tuple" }
%"class.std::tuple" = type { %"struct.std::_Tuple_impl" }
%"struct.std::_Tuple_impl" = type { %"struct.std::_Head_base.7" }
%"struct.std::_Head_base.7" = type { %"struct.absl::lts_20250127::log_internal::LogMessage::LogMessageData"* }
%"struct.absl::lts_20250127::log_internal::LogMessage::LogMessageData" = type opaque
%"class.tensorflow::VariantTensorDataProto" = type { %"class.google::protobuf::Message", %union.anon.51 }
%union.anon.51 = type { %"struct.tensorflow::VariantTensorDataProto::Impl_" }
...
%"struct.std::_Head_base.62" = type { %"class.tensorflow::TensorInterface"* }
%"class.__gnu_cxx::__normal_iterator" = type { %"class.tensorflow::Tensor"* }
%"class.absl::lts_20250127::log_internal::LogMessage::OstreamView" = type { %"class.std::basic_streambuf", %"struct.absl::lts_20250127::log_internal::LogMessage::LogMessageData"*, %"struct.std::ios_base::_Words", %"struct.std::ios_base::_Words", %"struct.std::ios_base::_Words" }
...
$_ZN4absl12lts_2025012712log_internal21GetReferenceableValueIPN10tensorflow7VariantEEERKT_S8_ = comdat any

$_ZN4absl12lts_2025012712log_internal21GetReferenceableValueIDnEERKT_S5_ = comdat any

$_ZN4absl12lts_2025012712log_internal12Check_NEImplIPN10tensorflow7VariantEDnEEPKcRKT_RKT0_S7_ = comdat any

$_ZN4absl12lts_2025012713implicit_castIPKcEET_NS0_8internal13type_identityIS4_E4typeE = comdat any

$_ZN4absl12lts_2025012712log_internal10LogMessage14InternalStreamEv = comdat any

$_ZNKO4absl12lts_2025012712log_internal7VoidifyaaINS1_10LogMessageEEEvRKT_ = comdat any
...
$_ZN4absl12lts_2025012712log_internal10LogMessagelsIPKcLi0EEERS2_RKT_ = comdat any

$_ZN4absl12lts_2025012712log_internal10LogMessagelsILi6EEERS2_RAT__Kc = comdat any
...
$_ZNKSt10unique_ptrIN4absl12lts_2025012712log_internal10LogMessage14LogMessageDataESt14default_deleteIS4_EEdeEv = comdat any

$_ZN4absl12lts_2025012712log_internal9NullGuardIPKcE5GuardES4_ = comdat any

$_ZNKSt5arrayIcLm7EE4dataEv = comdat any

$_ZNSt14__array_traitsIcLm7EE6_S_ptrERA7_Kc = comdat any

$_ZNKSt10unique_ptrIN4absl12lts_2025012712log_internal10LogMessage14LogMessageDataESt14default_deleteIS4_EE3getEv = comdat any

$_ZNKSt15__uniq_ptr_implIN4absl12lts_2025012712log_internal10LogMessage14LogMessageDataESt14default_deleteIS4_EE6_M_ptrEv = comdat any

$_ZSt3getILm0EJPN4absl12lts_2025012712log_internal10LogMessage14LogMessageDataESt14default_deleteIS4_EEERKNSt13tuple_elementIXT_ESt5tupleIJDpT0_EEE4typeERKSC_ = comdat any

$_ZSt12__get_helperILm0EPN4absl12lts_2025012712log_internal10LogMessage14LogMessageDataEJSt14default_deleteIS4_EEERKT0_RKSt11_Tuple_implIXT_EJS8_DpT1_EE = comdat any

$_ZNSt11_Tuple_implILm0EJPN4absl12lts_2025012712log_internal10LogMessage14LogMessageDataESt14default_deleteIS4_EEE7_M_headERKS8_ = comdat any

$_ZNSt10_Head_baseILm0EPN4absl12lts_2025012712log_internal10LogMessage14LogMessageDataELb0EE7_M_headERKS6_ = comdat any
...
$_ZN4absl12lts_2025012712log_internal21GetReferenceableValueIN10tensorflow8DataTypeEEERKT_S7_ = comdat any

$_ZN4absl12lts_2025012712log_internal12Check_EQImplIN10tensorflow8DataTypeES4_EEPKcRKT_RKT0_S6_ = comdat any

$_ZN4absl12lts_2025012712log_internal10LogMessagelsILi2EEERS2_RAT__Kc = comdat any

$_ZN4absl12lts_2025012712log_internal10LogMessagelsILi16EEERS2_RAT__Kc = comdat any

$_ZN4absl12lts_2025012712log_internal10LogMessagelsILi7EEERS2_RAT__Kc = comdat any

$_ZN4absl12lts_2025012712log_internal10LogMessagelsEPv = comdat any

$_ZN4absl12lts_2025012712log_internal10LogMessagelsILi27EEERS2_RAT__Kc = comdat any

$_ZN4absl12lts_2025012712log_internal21GetReferenceableValueEi = comdat any

$_ZN4absl12lts_2025012712log_internal21GetReferenceableValueEl = comdat any

$_ZN4absl12lts_2025012712log_internal12Check_EQImplIilEEPKcRKT_RKT0_S4_ = comdat any

$_ZN4absl12lts_2025012712log_internal10LogMessagelsILi31EEERS2_RAT__Kc = comdat any
...
@.str.27 = private unnamed_addr constant [15 x i8] c"buf != nullptr\00", align 1
...
@.str.20 = private unnamed_addr constant [29 x i8] c"TypeId() == memory->TypeId()\00", align 1
@.str.21 = private unnamed_addr constant [6 x i8] c" vs. \00", align 1
@_ZN4absl12lts_2025012712log_internal9kCharNullE = external dso_local global %"struct.std::array", align 1
...
@.str.4.18 = private unnamed_addr constant [26 x i8] c"dtype() == expected_dtype\00", align 1
@.str.5.19 = private unnamed_addr constant [78 x i8] c"/home/mushfiqur/Desktop/Github/tensorflow/tensorflow/core/framework/tensor.cc\00", align 1
@.str.6.20 = private unnamed_addr constant [2 x i8] c" \00", align 1
@.str.7.21 = private unnamed_addr constant [16 x i8] c" expected, got \00", align 1
@.str.8.22 = private unnamed_addr constant [12 x i8] c"IsAligned()\00", align 1
@.str.9.23 = private unnamed_addr constant [7 x i8] c"ptr = \00", align 1
@.str.10.24 = private unnamed_addr constant [27 x i8] c"Aligned and single element\00", align 1
@.str.11.25 = private unnamed_addr constant [19 x i8] c"1 == NumElements()\00", align 1
@.str.12.26 = private unnamed_addr constant [31 x i8] c"Must have a one element tensor\00", align 1
...
entry:
  call void @_ZNSt8ios_base4InitC1Ev(%"class.std::ios_base::Init"* @_ZStL8__ioinit.17)
  %0 = call i32 @__cxa_atexit(void (i8*)* bitcast (void (%"class.std::ios_base::Init"*)* @_ZNSt8ios_base4InitD1Ev to void (i8*)*), i8* getelementptr inbounds (%"class.std::ios_base::Init", %"class.std::ios_base::Init"* @_ZStL8__ioinit.17, i32 0, i32 0), i8* bitcast (i8** @__dso_handle to i8*)) #11
  ret void
}
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local void @_ZNSt8functionIFbPN10tensorflow7VariantEEEC2IZNS0_35variant_op_registry_fn_registration30UnaryVariantDecodeRegistrationINS0_6TensorEEC1ERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEUlS2_E_vEEOT_(%"class.std::function.49"* %this, %class.anon* nonnull align 8 dereferenceable(32) %__f) unnamed_addr #6 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
  %this.addr = alloca %"class.std::function.49"*, align 8
  %__f.addr = alloca %class.anon*, align 8
  %exn.slot = alloca i8*, align 8
  %ehselector.slot = alloca i32, align 4
  store %"class.std::function.49"* %this, %"class.std::function.49"** %this.addr, align 8
  store %class.anon* %__f, %class.anon** %__f.addr, align 8
  %this1 = load %"class.std::function.49"*, %"class.std::function.49"** %this.addr, align 8
  %0 = bitcast %"class.std::function.49"* %this1 to %"class.std::ios_base::Init"*
  %1 = bitcast %"class.std::function.49"* %this1 to %"class.std::_Function_base"*
  ...
  %_M_invoker = getelementptr inbounds %"class.std::function.49", %"class.std::function.49"* %this1, i32 0, i32 1
...
if.then:                                          ; preds = %invoke.cont
  %6 = bitcast %"class.std::function.49"* %this1 to %"class.std::_Function_base"*
...
invoke.cont3:                                     ; preds = %if.then
  %_M_invoker4 = getelementptr inbounds %"class.std::function.49", %"class.std::function.49"* %this1, i32 0, i32 1
  ...
  %8 = bitcast %"class.std::function.49"* %this1 to %"class.std::_Function_base"*
...
lpad:                                             ; preds = %if.then, %entry
  ...
  %11 = extractvalue { i8*, i32 } %9, 1
  store i32 %11, i32* %ehselector.slot, align 4
  %12 = bitcast %"class.std::function.49"* %this1 to %"class.std::_Function_base"*
...
declare dso_local void @_ZN10tensorflow22UnaryVariantOpRegistry16RegisterDecodeFnERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEERKSt8functionIFbPNS_7VariantEEE(%"class.tensorflow::UnaryVariantOpRegistry"*, %"class.std::__cxx11::basic_string"* nonnull align 8 dereferenceable(32), %"class.std::function.49"* nonnull align 8 dereferenceable(32)) #4

; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSt8functionIFbPN10tensorflow7VariantEEED2Ev(%"class.std::function.49"* %this) unnamed_addr #0 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::function.49"*, align 8
  store %"class.std::function.49"* %this, %"class.std::function.49"** %this.addr, align 8
  %this1 = load %"class.std::function.49"*, %"class.std::function.49"** %this.addr, align 8
  %0 = bitcast %"class.std::function.49"* %this1 to %"class.std::_Function_base"*
...
while.cond:                                       ; preds = %entry
  %call = call nonnull align 8 dereferenceable(8) %"class.tensorflow::Variant"** @_ZN4absl12lts_2025012712log_internal21GetReferenceableValueIPN10tensorflow7VariantEEERKT_S8_(%"class.tensorflow::Variant"** nonnull align 8 dereferenceable(8) %v.addr)
  store i8* null, i8** %ref.tmp, align 8
  %call2 = call nonnull align 8 dereferenceable(8) i8** @_ZN4absl12lts_2025012712log_internal21GetReferenceableValueIDnEERKT_S5_(i8** nonnull align 8 dereferenceable(8) %ref.tmp)
  %call3 = call i8* @_ZN4absl12lts_2025012712log_internal12Check_NEImplIPN10tensorflow7VariantEDnEEPKcRKT_RKT0_S7_(%"class.tensorflow::Variant"** nonnull align 8 dereferenceable(8) %call, i8** nonnull align 8 dereferenceable(8) %call2, i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.16, i64 0, i64 0))
  store i8* %call3, i8** %absl_log_internal_check_op_result, align 8
  %0 = load i8*, i8** %absl_log_internal_check_op_result, align 8
  %tobool = icmp ne i8* %0, null
  br i1 %tobool, label %while.body, label %while.end

while.body:                                       ; preds = %while.cond
  %1 = load i8*, i8** %absl_log_internal_check_op_result, align 8
  %call6 = call i8* @_ZN4absl12lts_2025012713implicit_castIPKcEET_NS0_8internal13type_identityIS4_E4typeE(i8* %1)
  call void @_ZN4absl12lts_2025012712log_internal15LogMessageFatalC1EPKciS4_(%"class.absl::lts_20250127::log_internal::LogMessageFatal"* %ref.tmp5, i8* getelementptr inbounds ([90 x i8], [90 x i8]* @.str.17, i64 0, i64 0), i32 373, i8* %call6) #22
  %2 = bitcast %"class.absl::lts_20250127::log_internal::LogMessageFatal"* %ref.tmp5 to %"class.absl::lts_20250127::log_internal::LogMessage"*
  %call7 = invoke nonnull align 8 dereferenceable(16) %"class.absl::lts_20250127::log_internal::LogMessage"* @_ZN4absl12lts_2025012712log_internal10LogMessage14InternalStreamEv(%"class.absl::lts_20250127::log_internal::LogMessage"* %2)
          to label %invoke.cont unwind label %lpad

invoke.cont:                                      ; preds = %while.body
  invoke void @_ZNKO4absl12lts_2025012712log_internal7VoidifyaaINS1_10LogMessageEEEvRKT_(%"class.std::ios_base::Init"* %ref.tmp4, %"class.absl::lts_20250127::log_internal::LogMessage"* nonnull align 8 dereferenceable(16) %call7)
          to label %invoke.cont8 unwind label %lpad

invoke.cont8:                                     ; preds = %invoke.cont
  call void @_ZN4absl12lts_2025012712log_internal15LogMessageFatalD1Ev(%"class.absl::lts_20250127::log_internal::LogMessageFatal"* %ref.tmp5) #16
  unreachable
...
while.end:                                        ; preds = %while.cond
  %7 = load %"class.tensorflow::Variant"*, %"class.tensorflow::Variant"** %v.addr, align 8
  %call9 = call %"class.tensorflow::VariantTensorDataProto"* @_ZN10tensorflow7Variant3getINS_22VariantTensorDataProtoEEEPT_v(%"class.tensorflow::Variant"* %7)
  store %"class.tensorflow::VariantTensorDataProto"* %call9, %"class.tensorflow::VariantTensorDataProto"** %t, align 8
  %8 = load %"class.tensorflow::VariantTensorDataProto"*, %"class.tensorflow::VariantTensorDataProto"** %t, align 8
  %cmp = icmp eq %"class.tensorflow::VariantTensorDataProto"* %8, null
  br i1 %cmp, label %if.then, label %if.end
...
if.end:                                           ; preds = %while.end
  call void @_ZN10tensorflow6TensorC1Ev(%"class.tensorflow::Tensor"* %ref.tmp10)
  invoke void @_ZN10tensorflow7VariantC2INS_6TensorES2_LPv0EEEOT_(%"class.tensorflow::Variant"* %decoded, %"class.tensorflow::Tensor"* nonnull align 8 dereferenceable(32) %ref.tmp10)
          to label %invoke.cont12 unwind label %lpad11

invoke.cont12:                                    ; preds = %if.end
  call void @_ZN10tensorflow6TensorD1Ev(%"class.tensorflow::Tensor"* %ref.tmp10) #11
  %9 = load %"class.tensorflow::VariantTensorDataProto"*, %"class.tensorflow::VariantTensorDataProto"** %t, align 8
  %call13 = call nonnull align 8 dereferenceable(64) %"class.tensorflow::VariantTensorDataProto"* @_ZSt4moveIRN10tensorflow22VariantTensorDataProtoEEONSt16remove_referenceIT_E4typeEOS4_(%"class.tensorflow::VariantTensorDataProto"* nonnull align 8 dereferenceable(64) %9) #11
  call void @_ZN10tensorflow22VariantTensorDataProtoC2EOS0_(%"class.tensorflow::VariantTensorDataProto"* %agg.tmp, %"class.tensorflow::VariantTensorDataProto"* nonnull align 8 dereferenceable(64) %call13) #11
...
invoke.cont15:                                    ; preds = %invoke.cont12
  ...
  %call17 = call nonnull align 8 dereferenceable(88) %"class.tensorflow::VariantTensorData"* @_ZSt4moveIRN10tensorflow17VariantTensorDataEEONSt16remove_referenceIT_E4typeEOS4_(%"class.tensorflow::VariantTensorData"* nonnull align 8 dereferenceable(88) %data) #11
  call void @_ZN10tensorflow17VariantTensorDataC2EOS0_(%"class.tensorflow::VariantTensorData"* %agg.tmp16, %"class.tensorflow::VariantTensorData"* nonnull align 8 dereferenceable(88) %call17) #11
  %call20 = invoke zeroext i1 @_ZN10tensorflow7Variant6DecodeENS_17VariantTensorDataE(%"class.tensorflow::Variant"* %decoded, %"class.tensorflow::VariantTensorData"* %agg.tmp16)
          to label %invoke.cont19 unwind label %lpad18

invoke.cont19:                                    ; preds = %invoke.cont15
  %lnot = xor i1 %call20, true
  call void @_ZN10tensorflow17VariantTensorDataD2Ev(%"class.tensorflow::VariantTensorData"* %agg.tmp16) #11
...
if.end22:                                         ; preds = %invoke.cont19
  %19 = load %"class.tensorflow::Variant"*, %"class.tensorflow::Variant"** %v.addr, align 8
  call void @_ZSt4swapIN10tensorflow7VariantEENSt9enable_ifIXsr6__and_ISt6__not_ISt15__is_tuple_likeIT_EESt21is_move_constructibleIS5_ESt18is_move_assignableIS5_EEE5valueEvE4typeERS5_SE_(%"class.tensorflow::Variant"* nonnull align 8 dereferenceable(57) %decoded, %"class.tensorflow::Variant"* nonnull align 8 dereferenceable(57) %19) #11
  store i1 true, i1* %retval, align 1
  store i32 1, i32* %cleanup.dest.slot, align 4
  br label %cleanup
...
eh.resume:                                        ; preds = %ehcleanup, %lpad11, %6
  %exn = load i8*, i8** %exn.slot, align 8
  %sel = load i32, i32* %ehselector.slot, align 4
  %lpad.val = insertvalue { i8*, i32 } undef, i8* %exn, 0
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local nonnull align 8 dereferenceable(8) %"class.tensorflow::Variant"** @_ZN4absl12lts_2025012712log_internal21GetReferenceableValueIPN10tensorflow7VariantEEERKT_S8_(%"class.tensorflow::Variant"** nonnull align 8 dereferenceable(8) %t) #0 comdat {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local nonnull align 8 dereferenceable(8) i8** @_ZN4absl12lts_2025012712log_internal21GetReferenceableValueIDnEERKT_S5_(i8** nonnull align 8 dereferenceable(8) %t) #0 comdat {
entry:
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local i8* @_ZN4absl12lts_2025012712log_internal12Check_NEImplIPN10tensorflow7VariantEDnEEPKcRKT_RKT0_S7_(%"class.tensorflow::Variant"** nonnull align 8 dereferenceable(8) %v1, i8** nonnull align 8 dereferenceable(8) %v2, i8* %exprtext) #6 comdat {
entry:
...
cond.false:                                       ; preds = %entry
  ...
  %4 = load %"class.tensorflow::Variant"*, %"class.tensorflow::Variant"** %3, align 8
  %5 = bitcast %"class.tensorflow::Variant"* %4 to i8*
  %6 = load i8**, i8*** %v2.addr, align 8
  %7 = load i8*, i8** %exprtext.addr, align 8
  %call = call nonnull i8* @_ZN4absl12lts_2025012712log_internal17MakeCheckOpStringIPKvS4_EEPKcT_T0_S6_(i8* %5, i8* null, i8* %7)
  br label %cond.end
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local i8* @_ZN4absl12lts_2025012713implicit_castIPKcEET_NS0_8internal13type_identityIS4_E4typeE(i8* %to) #0 comdat {
entry:
...
; Function Attrs: cold
declare dso_local void @_ZN4absl12lts_2025012712log_internal15LogMessageFatalC1EPKciS4_(%"class.absl::lts_20250127::log_internal::LogMessageFatal"*, i8*, i32, i8*) unnamed_addr #14

; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local nonnull align 8 dereferenceable(16) %"class.absl::lts_20250127::log_internal::LogMessage"* @_ZN4absl12lts_2025012712log_internal10LogMessage14InternalStreamEv(%"class.absl::lts_20250127::log_internal::LogMessage"* %this) #0 comdat align 2 {
entry:
  %this.addr = alloca %"class.absl::lts_20250127::log_internal::LogMessage"*, align 8
  store %"class.absl::lts_20250127::log_internal::LogMessage"* %this, %"class.absl::lts_20250127::log_internal::LogMessage"** %this.addr, align 8
  %this1 = load %"class.absl::lts_20250127::log_internal::LogMessage"*, %"class.absl::lts_20250127::log_internal::LogMessage"** %this.addr, align 8
  ret %"class.absl::lts_20250127::log_internal::LogMessage"* %this1
}

; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNKO4absl12lts_2025012712log_internal7VoidifyaaINS1_10LogMessageEEEvRKT_(%"class.std::ios_base::Init"* %this, %"class.absl::lts_20250127::log_internal::LogMessage"* nonnull align 8 dereferenceable(16) %0) #0 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::ios_base::Init"*, align 8
  %.addr = alloca %"class.absl::lts_20250127::log_internal::LogMessage"*, align 8
  store %"class.std::ios_base::Init"* %this, %"class.std::ios_base::Init"** %this.addr, align 8
  store %"class.absl::lts_20250127::log_internal::LogMessage"* %0, %"class.absl::lts_20250127::log_internal::LogMessage"** %.addr, align 8
  %this1 = load %"class.std::ios_base::Init"*, %"class.std::ios_base::Init"** %this.addr, align 8
  ret void
}

; Function Attrs: noreturn nounwind
declare dso_local void @_ZN4absl12lts_2025012712log_internal15LogMessageFatalD1Ev(%"class.absl::lts_20250127::log_internal::LogMessageFatal"*) unnamed_addr #5
...
if.then:                                          ; preds = %invoke.cont2
  ...
  %inline_value_ = bitcast %union.anon.22* %1 to %"struct.tensorflow::Variant::InlineValue"*
  ...
  %inline_value_4 = bitcast %union.anon.22* %5 to %"struct.tensorflow::Variant::InlineValue"*
...
if.else:                                          ; preds = %invoke.cont2
  ...
  %heap_value_ = bitcast %union.anon.22* %6 to %"class.std::unique_ptr.23"*
  %7 = bitcast %"class.std::unique_ptr.23"* %heap_value_ to i8*
  %8 = bitcast i8* %7 to %"class.std::unique_ptr.23"*
  ...
  %heap_value_6 = bitcast %union.anon.22* %10 to %"class.std::unique_ptr.23"*
  %call7 = call nonnull align 8 dereferenceable(8) %"class.std::unique_ptr.23"* @_ZSt4moveIRSt10unique_ptrIN10tensorflow7Variant14ValueInterfaceESt14default_deleteIS3_EEEONSt16remove_referenceIT_E4typeEOS9_(%"class.std::unique_ptr.23"* nonnull align 8 dereferenceable(8) %heap_value_6) #11
  call void @_ZNSt10unique_ptrIN10tensorflow7Variant14ValueInterfaceESt14default_deleteIS2_EEC2EOS5_(%"class.std::unique_ptr.23"* %8, %"class.std::unique_ptr.23"* nonnull align 8 dereferenceable(8) %call7) #11
  br label %if.end
...
entry:
  %this.addr = alloca %"class.tensorflow::Variant"*, align 8
  %other.addr = alloca %"class.tensorflow::Variant"*, align 8
  %v = alloca %"class.std::unique_ptr.23", align 8
  %v51 = alloca %"class.std::unique_ptr.23", align 8
  store %"class.tensorflow::Variant"* %this, %"class.tensorflow::Variant"** %this.addr, align 8
  store %"class.tensorflow::Variant"* %other, %"class.tensorflow::Variant"** %other.addr, align 8
  %this1 = load %"class.tensorflow::Variant"*, %"class.tensorflow::Variant"** %this.addr, align 8
  %call = invoke zeroext i1 @_ZNK10tensorflow7Variant8is_emptyEv(%"class.tensorflow::Variant"* %this1)
...
if.then4:                                         ; preds = %invoke.cont2
  ...
  %inline_value_ = bitcast %union.anon.22* %2 to %"struct.tensorflow::Variant::InlineValue"*
...
if.else:                                          ; preds = %invoke.cont2
  ...
  %heap_value_ = bitcast %union.anon.22* %4 to %"class.std::unique_ptr.23"*
  %call6 = call nonnull align 8 dereferenceable(8) %"class.std::unique_ptr.23"* @_ZSt4moveIRSt10unique_ptrIN10tensorflow7Variant14ValueInterfaceESt14default_deleteIS3_EEEONSt16remove_referenceIT_E4typeEOS9_(%"class.std::unique_ptr.23"* nonnull align 8 dereferenceable(8) %heap_value_) #11
  call void @_ZN10tensorflow7Variant15ResetAndSetHeapIJSt10unique_ptrINS0_14ValueInterfaceESt14default_deleteIS3_EEEEEvDpOT_(%"class.tensorflow::Variant"* %this1, %"class.std::unique_ptr.23"* nonnull align 8 dereferenceable(8) %call6) #11
  br label %if.end
...
if.then13:                                        ; preds = %invoke.cont11
  ...
  %inline_value_14 = bitcast %union.anon.22* %8 to %"struct.tensorflow::Variant::InlineValue"*
...
if.else16:                                        ; preds = %invoke.cont11
  ...
  %heap_value_17 = bitcast %union.anon.22* %10 to %"class.std::unique_ptr.23"*
  %call18 = call nonnull align 8 dereferenceable(8) %"class.std::unique_ptr.23"* @_ZSt4moveIRSt10unique_ptrIN10tensorflow7Variant14ValueInterfaceESt14default_deleteIS3_EEEONSt16remove_referenceIT_E4typeEOS9_(%"class.std::unique_ptr.23"* nonnull align 8 dereferenceable(8) %heap_value_17) #11
  call void @_ZN10tensorflow7Variant15ResetAndSetHeapIJSt10unique_ptrINS0_14ValueInterfaceESt14default_deleteIS3_EEEEEvDpOT_(%"class.tensorflow::Variant"* %9, %"class.std::unique_ptr.23"* nonnull align 8 dereferenceable(8) %call18) #11
  br label %if.end19
...
if.then25:                                        ; preds = %invoke.cont23
  ...
  %inline_value_26 = bitcast %union.anon.22* %12 to %"struct.tensorflow::Variant::InlineValue"*
  ...
  %inline_value_27 = bitcast %union.anon.22* %14 to %"struct.tensorflow::Variant::InlineValue"*
...
if.then35:                                        ; preds = %invoke.cont33
  ...
  %heap_value_36 = bitcast %union.anon.22* %16 to %"class.std::unique_ptr.23"*
  ...
  %heap_value_37 = bitcast %union.anon.22* %18 to %"class.std::unique_ptr.23"*
  call void @_ZSt4swapIN10tensorflow7Variant14ValueInterfaceESt14default_deleteIS2_EENSt9enable_ifIXsr14__is_swappableIT0_EE5valueEvE4typeERSt10unique_ptrIT_S6_ESC_(%"class.std::unique_ptr.23"* nonnull align 8 dereferenceable(8) %heap_value_36, %"class.std::unique_ptr.23"* nonnull align 8 dereferenceable(8) %heap_value_37) #11
  br label %if.end58
...
if.then44:                                        ; preds = %invoke.cont42
  ...
  %heap_value_45 = bitcast %union.anon.22* %20 to %"class.std::unique_ptr.23"*
  %call46 = call nonnull align 8 dereferenceable(8) %"class.std::unique_ptr.23"* @_ZSt4moveIRSt10unique_ptrIN10tensorflow7Variant14ValueInterfaceESt14default_deleteIS3_EEEONSt16remove_referenceIT_E4typeEOS9_(%"class.std::unique_ptr.23"* nonnull align 8 dereferenceable(8) %heap_value_45) #11
  call void @_ZNSt10unique_ptrIN10tensorflow7Variant14ValueInterfaceESt14default_deleteIS2_EEC2EOS5_(%"class.std::unique_ptr.23"* %v, %"class.std::unique_ptr.23"* nonnull align 8 dereferenceable(8) %call46) #11
  ...
  %inline_value_47 = bitcast %union.anon.22* %22 to %"struct.tensorflow::Variant::InlineValue"*
  ...
  %call49 = call nonnull align 8 dereferenceable(8) %"class.std::unique_ptr.23"* @_ZSt4moveIRSt10unique_ptrIN10tensorflow7Variant14ValueInterfaceESt14default_deleteIS3_EEEONSt16remove_referenceIT_E4typeEOS9_(%"class.std::unique_ptr.23"* nonnull align 8 dereferenceable(8) %v) #11
  call void @_ZN10tensorflow7Variant15ResetAndSetHeapIJSt10unique_ptrINS0_14ValueInterfaceESt14default_deleteIS3_EEEEEvDpOT_(%"class.tensorflow::Variant"* %23, %"class.std::unique_ptr.23"* nonnull align 8 dereferenceable(8) %call49) #11
  call void @_ZNSt10unique_ptrIN10tensorflow7Variant14ValueInterfaceESt14default_deleteIS2_EED2Ev(%"class.std::unique_ptr.23"* %v) #11
  br label %if.end57
...
if.else50:                                        ; preds = %invoke.cont42, %invoke.cont39
  ...
  %heap_value_52 = bitcast %union.anon.22* %25 to %"class.std::unique_ptr.23"*
  %call53 = call nonnull align 8 dereferenceable(8) %"class.std::unique_ptr.23"* @_ZSt4moveIRSt10unique_ptrIN10tensorflow7Variant14ValueInterfaceESt14default_deleteIS3_EEEONSt16remove_referenceIT_E4typeEOS9_(%"class.std::unique_ptr.23"* nonnull align 8 dereferenceable(8) %heap_value_52) #11
  call void @_ZNSt10unique_ptrIN10tensorflow7Variant14ValueInterfaceESt14default_deleteIS2_EEC2EOS5_(%"class.std::unique_ptr.23"* %v51, %"class.std::unique_ptr.23"* nonnull align 8 dereferenceable(8) %call53) #11
  ...
  %inline_value_54 = bitcast %union.anon.22* %27 to %"struct.tensorflow::Variant::InlineValue"*
  ...
  %call56 = call nonnull align 8 dereferenceable(8) %"class.std::unique_ptr.23"* @_ZSt4moveIRSt10unique_ptrIN10tensorflow7Variant14ValueInterfaceESt14default_deleteIS3_EEEONSt16remove_referenceIT_E4typeEOS9_(%"class.std::unique_ptr.23"* nonnull align 8 dereferenceable(8) %v51) #11
  call void @_ZN10tensorflow7Variant15ResetAndSetHeapIJSt10unique_ptrINS0_14ValueInterfaceESt14default_deleteIS3_EEEEEvDpOT_(%"class.tensorflow::Variant"* %this1, %"class.std::unique_ptr.23"* nonnull align 8 dereferenceable(8) %call56) #11
  call void @_ZNSt10unique_ptrIN10tensorflow7Variant14ValueInterfaceESt14default_deleteIS2_EED2Ev(%"class.std::unique_ptr.23"* %v51) #11
  br label %if.end57
...
invoke.cont:                                      ; preds = %entry
  ...
  %inline_value_ = bitcast %union.anon.22* %0 to %"struct.tensorflow::Variant::InlineValue"*
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local nonnull align 8 dereferenceable(8) %"class.std::unique_ptr.23"* @_ZSt4moveIRSt10unique_ptrIN10tensorflow7Variant14ValueInterfaceESt14default_deleteIS3_EEEONSt16remove_referenceIT_E4typeEOS9_(%"class.std::unique_ptr.23"* nonnull align 8 dereferenceable(8) %__t) #0 comdat {
entry:
  %__t.addr = alloca %"class.std::unique_ptr.23"*, align 8
  store %"class.std::unique_ptr.23"* %__t, %"class.std::unique_ptr.23"** %__t.addr, align 8
  %0 = load %"class.std::unique_ptr.23"*, %"class.std::unique_ptr.23"** %__t.addr, align 8
  ret %"class.std::unique_ptr.23"* %0
}

; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZN10tensorflow7Variant15ResetAndSetHeapIJSt10unique_ptrINS0_14ValueInterfaceESt14default_deleteIS3_EEEEEvDpOT_(%"class.tensorflow::Variant"* %this, %"class.std::unique_ptr.23"* nonnull align 8 dereferenceable(8) %args) #0 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
  %this.addr = alloca %"class.tensorflow::Variant"*, align 8
  %args.addr = alloca %"class.std::unique_ptr.23"*, align 8
  store %"class.tensorflow::Variant"* %this, %"class.tensorflow::Variant"** %this.addr, align 8
  store %"class.std::unique_ptr.23"* %args, %"class.std::unique_ptr.23"** %args.addr, align 8
  %this1 = load %"class.tensorflow::Variant"*, %"class.tensorflow::Variant"** %this.addr, align 8
  invoke void @_ZN10tensorflow7Variant11ResetMemoryEv(%"class.tensorflow::Variant"* %this1)
          to label %invoke.cont unwind label %terminate.lpad
...
invoke.cont:                                      ; preds = %entry
  %0 = getelementptr inbounds %"class.tensorflow::Variant", %"class.tensorflow::Variant"* %this1, i32 0, i32 0
  %heap_value_ = bitcast %union.anon.22* %0 to %"class.std::unique_ptr.23"*
  %1 = bitcast %"class.std::unique_ptr.23"* %heap_value_ to i8*
  %2 = bitcast i8* %1 to %"class.std::unique_ptr.23"*
  %3 = load %"class.std::unique_ptr.23"*, %"class.std::unique_ptr.23"** %args.addr, align 8
  %call = call nonnull align 8 dereferenceable(8) %"class.std::unique_ptr.23"* @_ZSt7forwardISt10unique_ptrIN10tensorflow7Variant14ValueInterfaceESt14default_deleteIS3_EEEOT_RNSt16remove_referenceIS7_E4typeE(%"class.std::unique_ptr.23"* nonnull align 8 dereferenceable(8) %3) #11
  call void @_ZNSt10unique_ptrIN10tensorflow7Variant14ValueInterfaceESt14default_deleteIS2_EEC2EOS5_(%"class.std::unique_ptr.23"* %2, %"class.std::unique_ptr.23"* nonnull align 8 dereferenceable(8) %call) #11
  %is_inline_ = getelementptr inbounds %"class.tensorflow::Variant", %"class.tensorflow::Variant"* %this1, i32 0, i32 1
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZSt4swapIN10tensorflow7Variant14ValueInterfaceESt14default_deleteIS2_EENSt9enable_ifIXsr14__is_swappableIT0_EE5valueEvE4typeERSt10unique_ptrIT_S6_ESC_(%"class.std::unique_ptr.23"* nonnull align 8 dereferenceable(8) %__x, %"class.std::unique_ptr.23"* nonnull align 8 dereferenceable(8) %__y) #0 comdat {
entry:
  %__x.addr = alloca %"class.std::unique_ptr.23"*, align 8
  %__y.addr = alloca %"class.std::unique_ptr.23"*, align 8
  store %"class.std::unique_ptr.23"* %__x, %"class.std::unique_ptr.23"** %__x.addr, align 8
  store %"class.std::unique_ptr.23"* %__y, %"class.std::unique_ptr.23"** %__y.addr, align 8
  %0 = load %"class.std::unique_ptr.23"*, %"class.std::unique_ptr.23"** %__x.addr, align 8
  %1 = load %"class.std::unique_ptr.23"*, %"class.std::unique_ptr.23"** %__y.addr, align 8
  call void @_ZNSt10unique_ptrIN10tensorflow7Variant14ValueInterfaceESt14default_deleteIS2_EE4swapERS5_(%"class.std::unique_ptr.23"* %0, %"class.std::unique_ptr.23"* nonnull align 8 dereferenceable(8) %1) #11
  ret void
}

; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSt10unique_ptrIN10tensorflow7Variant14ValueInterfaceESt14default_deleteIS2_EEC2EOS5_(%"class.std::unique_ptr.23"* %this, %"class.std::unique_ptr.23"* nonnull align 8 dereferenceable(8) %0) unnamed_addr #0 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::unique_ptr.23"*, align 8
  %.addr = alloca %"class.std::unique_ptr.23"*, align 8
  store %"class.std::unique_ptr.23"* %this, %"class.std::unique_ptr.23"** %this.addr, align 8
  store %"class.std::unique_ptr.23"* %0, %"class.std::unique_ptr.23"** %.addr, align 8
  %this1 = load %"class.std::unique_ptr.23"*, %"class.std::unique_ptr.23"** %this.addr, align 8
  %_M_t = getelementptr inbounds %"class.std::unique_ptr.23", %"class.std::unique_ptr.23"* %this1, i32 0, i32 0
  %1 = load %"class.std::unique_ptr.23"*, %"class.std::unique_ptr.23"** %.addr, align 8
  %_M_t2 = getelementptr inbounds %"class.std::unique_ptr.23", %"class.std::unique_ptr.23"* %1, i32 0, i32 0
  call void @_ZNSt15__uniq_ptr_dataIN10tensorflow7Variant14ValueInterfaceESt14default_deleteIS2_ELb1ELb1EEC2EOS5_(%"struct.std::__uniq_ptr_data.24"* %_M_t, %"struct.std::__uniq_ptr_data.24"* nonnull align 8 dereferenceable(8) %_M_t2) #11
  ret void
}

; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSt10unique_ptrIN10tensorflow7Variant14ValueInterfaceESt14default_deleteIS2_EED2Ev(%"class.std::unique_ptr.23"* %this) unnamed_addr #0 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
  %this.addr = alloca %"class.std::unique_ptr.23"*, align 8
  ...
  %this1 = load %"class.std::unique_ptr.23"*, %"class.std::unique_ptr.23"** %this.addr, align 8
  %_M_t = getelementptr inbounds %"class.std::unique_ptr.23", %"class.std::unique_ptr.23"* %this1, i32 0, i32 0
  %0 = bitcast %"struct.std::__uniq_ptr_data.24"* %_M_t to %"class.std::__uniq_ptr_impl.25"*
  %call = invoke nonnull align 8 dereferenceable(8) %"class.tensorflow::AbstractTensorInterface"** @_ZNSt15__uniq_ptr_implIN10tensorflow7Variant14ValueInterfaceESt14default_deleteIS2_EE6_M_ptrEv(%"class.std::__uniq_ptr_impl.25"* %0)
          to label %invoke.cont unwind label %terminate.lpad
...
if.then:                                          ; preds = %invoke.cont
  %call2 = call nonnull align 1 dereferenceable(1) %"class.std::ios_base::Init"* @_ZNSt10unique_ptrIN10tensorflow7Variant14ValueInterfaceESt14default_deleteIS2_EE11get_deleterEv(%"class.std::unique_ptr.23"* %this1) #11
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local nonnull align 8 dereferenceable(8) %"class.tensorflow::AbstractTensorInterface"** @_ZNSt15__uniq_ptr_implIN10tensorflow7Variant14ValueInterfaceESt14default_deleteIS2_EE6_M_ptrEv(%"class.std::__uniq_ptr_impl.25"* %this) #0 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::__uniq_ptr_impl.25"*, align 8
  store %"class.std::__uniq_ptr_impl.25"* %this, %"class.std::__uniq_ptr_impl.25"** %this.addr, align 8
  %this1 = load %"class.std::__uniq_ptr_impl.25"*, %"class.std::__uniq_ptr_impl.25"** %this.addr, align 8
  %_M_t = getelementptr inbounds %"class.std::__uniq_ptr_impl.25", %"class.std::__uniq_ptr_impl.25"* %this1, i32 0, i32 0
  %call = call nonnull align 8 dereferenceable(8) %"class.tensorflow::AbstractTensorInterface"** @_ZSt3getILm0EJPN10tensorflow7Variant14ValueInterfaceESt14default_deleteIS2_EEERNSt13tuple_elementIXT_ESt5tupleIJDpT0_EEE4typeERSA_(%"class.std::tuple.26"* nonnull align 8 dereferenceable(8) %_M_t) #11
  ret %"class.tensorflow::AbstractTensorInterface"** %call
}

; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local nonnull align 1 dereferenceable(1) %"class.std::ios_base::Init"* @_ZNSt10unique_ptrIN10tensorflow7Variant14ValueInterfaceESt14default_deleteIS2_EE11get_deleterEv(%"class.std::unique_ptr.23"* %this) #0 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
  %this.addr = alloca %"class.std::unique_ptr.23"*, align 8
  store %"class.std::unique_ptr.23"* %this, %"class.std::unique_ptr.23"** %this.addr, align 8
  %this1 = load %"class.std::unique_ptr.23"*, %"class.std::unique_ptr.23"** %this.addr, align 8
  %_M_t = getelementptr inbounds %"class.std::unique_ptr.23", %"class.std::unique_ptr.23"* %this1, i32 0, i32 0
  %0 = bitcast %"struct.std::__uniq_ptr_data.24"* %_M_t to %"class.std::__uniq_ptr_impl.25"*
  %call = invoke nonnull align 1 dereferenceable(1) %"class.std::ios_base::Init"* @_ZNSt15__uniq_ptr_implIN10tensorflow7Variant14ValueInterfaceESt14default_deleteIS2_EE10_M_deleterEv(%"class.std::__uniq_ptr_impl.25"* %0)
          to label %invoke.cont unwind label %terminate.lpad
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local nonnull align 1 dereferenceable(1) %"class.std::ios_base::Init"* @_ZNSt15__uniq_ptr_implIN10tensorflow7Variant14ValueInterfaceESt14default_deleteIS2_EE10_M_deleterEv(%"class.std::__uniq_ptr_impl.25"* %this) #0 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::__uniq_ptr_impl.25"*, align 8
  store %"class.std::__uniq_ptr_impl.25"* %this, %"class.std::__uniq_ptr_impl.25"** %this.addr, align 8
  %this1 = load %"class.std::__uniq_ptr_impl.25"*, %"class.std::__uniq_ptr_impl.25"** %this.addr, align 8
  %_M_t = getelementptr inbounds %"class.std::__uniq_ptr_impl.25", %"class.std::__uniq_ptr_impl.25"* %this1, i32 0, i32 0
  %call = call nonnull align 1 dereferenceable(1) %"class.std::ios_base::Init"* @_ZSt3getILm1EJPN10tensorflow7Variant14ValueInterfaceESt14default_deleteIS2_EEERNSt13tuple_elementIXT_ESt5tupleIJDpT0_EEE4typeERSA_(%"class.std::tuple.26"* nonnull align 8 dereferenceable(8) %_M_t) #11
  ret %"class.std::ios_base::Init"* %call
}

; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local nonnull align 1 dereferenceable(1) %"class.std::ios_base::Init"* @_ZSt3getILm1EJPN10tensorflow7Variant14ValueInterfaceESt14default_deleteIS2_EEERNSt13tuple_elementIXT_ESt5tupleIJDpT0_EEE4typeERSA_(%"class.std::tuple.26"* nonnull align 8 dereferenceable(8) %__t) #0 comdat {
entry:
  %__t.addr = alloca %"class.std::tuple.26"*, align 8
  store %"class.std::tuple.26"* %__t, %"class.std::tuple.26"** %__t.addr, align 8
  %0 = load %"class.std::tuple.26"*, %"class.std::tuple.26"** %__t.addr, align 8
  %1 = bitcast %"class.std::tuple.26"* %0 to %"class.std::ios_base::Init"*
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local nonnull align 8 dereferenceable(8) %"class.tensorflow::AbstractTensorInterface"** @_ZSt3getILm0EJPN10tensorflow7Variant14ValueInterfaceESt14default_deleteIS2_EEERNSt13tuple_elementIXT_ESt5tupleIJDpT0_EEE4typeERSA_(%"class.std::tuple.26"* nonnull align 8 dereferenceable(8) %__t) #0 comdat {
entry:
  %__t.addr = alloca %"class.std::tuple.26"*, align 8
  store %"class.std::tuple.26"* %__t, %"class.std::tuple.26"** %__t.addr, align 8
  %0 = load %"class.std::tuple.26"*, %"class.std::tuple.26"** %__t.addr, align 8
  %1 = bitcast %"class.std::tuple.26"* %0 to %"struct.std::_Tuple_impl.27"*
  %call = call nonnull align 8 dereferenceable(8) %"class.tensorflow::AbstractTensorInterface"** @_ZSt12__get_helperILm0EPN10tensorflow7Variant14ValueInterfaceEJSt14default_deleteIS2_EEERT0_RSt11_Tuple_implIXT_EJS6_DpT1_EE(%"struct.std::_Tuple_impl.27"* nonnull align 8 dereferenceable(8) %1) #11
  ret %"class.tensorflow::AbstractTensorInterface"** %call
}

; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local nonnull align 8 dereferenceable(8) %"class.tensorflow::AbstractTensorInterface"** @_ZSt12__get_helperILm0EPN10tensorflow7Variant14ValueInterfaceEJSt14default_deleteIS2_EEERT0_RSt11_Tuple_implIXT_EJS6_DpT1_EE(%"struct.std::_Tuple_impl.27"* nonnull align 8 dereferenceable(8) %__t) #0 comdat {
entry:
  %__t.addr = alloca %"struct.std::_Tuple_impl.27"*, align 8
  store %"struct.std::_Tuple_impl.27"* %__t, %"struct.std::_Tuple_impl.27"** %__t.addr, align 8
  %0 = load %"struct.std::_Tuple_impl.27"*, %"struct.std::_Tuple_impl.27"** %__t.addr, align 8
  %call = call nonnull align 8 dereferenceable(8) %"class.tensorflow::AbstractTensorInterface"** @_ZNSt11_Tuple_implILm0EJPN10tensorflow7Variant14ValueInterfaceESt14default_deleteIS2_EEE7_M_headERS6_(%"struct.std::_Tuple_impl.27"* nonnull align 8 dereferenceable(8) %0) #11
  ret %"class.tensorflow::AbstractTensorInterface"** %call
}

; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local nonnull align 8 dereferenceable(8) %"class.tensorflow::AbstractTensorInterface"** @_ZNSt11_Tuple_implILm0EJPN10tensorflow7Variant14ValueInterfaceESt14default_deleteIS2_EEE7_M_headERS6_(%"struct.std::_Tuple_impl.27"* nonnull align 8 dereferenceable(8) %__t) #0 comdat align 2 {
entry:
  %__t.addr = alloca %"struct.std::_Tuple_impl.27"*, align 8
  store %"struct.std::_Tuple_impl.27"* %__t, %"struct.std::_Tuple_impl.27"** %__t.addr, align 8
  %0 = load %"struct.std::_Tuple_impl.27"*, %"struct.std::_Tuple_impl.27"** %__t.addr, align 8
  %1 = bitcast %"struct.std::_Tuple_impl.27"* %0 to %struct.TF_Tensor*
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSt15__uniq_ptr_dataIN10tensorflow7Variant14ValueInterfaceESt14default_deleteIS2_ELb1ELb1EEC2EOS5_(%"struct.std::__uniq_ptr_data.24"* %this, %"struct.std::__uniq_ptr_data.24"* nonnull align 8 dereferenceable(8) %0) unnamed_addr #0 comdat align 2 {
entry:
  %this.addr = alloca %"struct.std::__uniq_ptr_data.24"*, align 8
  %.addr = alloca %"struct.std::__uniq_ptr_data.24"*, align 8
  store %"struct.std::__uniq_ptr_data.24"* %this, %"struct.std::__uniq_ptr_data.24"** %this.addr, align 8
  store %"struct.std::__uniq_ptr_data.24"* %0, %"struct.std::__uniq_ptr_data.24"** %.addr, align 8
  %this1 = load %"struct.std::__uniq_ptr_data.24"*, %"struct.std::__uniq_ptr_data.24"** %this.addr, align 8
  %1 = bitcast %"struct.std::__uniq_ptr_data.24"* %this1 to %"class.std::__uniq_ptr_impl.25"*
  %2 = load %"struct.std::__uniq_ptr_data.24"*, %"struct.std::__uniq_ptr_data.24"** %.addr, align 8
  %3 = bitcast %"struct.std::__uniq_ptr_data.24"* %2 to %"class.std::__uniq_ptr_impl.25"*
  call void @_ZNSt15__uniq_ptr_implIN10tensorflow7Variant14ValueInterfaceESt14default_deleteIS2_EEC2EOS5_(%"class.std::__uniq_ptr_impl.25"* %1, %"class.std::__uniq_ptr_impl.25"* nonnull align 8 dereferenceable(8) %3) #11
  ret void
}

; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSt15__uniq_ptr_implIN10tensorflow7Variant14ValueInterfaceESt14default_deleteIS2_EEC2EOS5_(%"class.std::__uniq_ptr_impl.25"* %this, %"class.std::__uniq_ptr_impl.25"* nonnull align 8 dereferenceable(8) %__u) unnamed_addr #0 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
  %this.addr = alloca %"class.std::__uniq_ptr_impl.25"*, align 8
  %__u.addr = alloca %"class.std::__uniq_ptr_impl.25"*, align 8
  store %"class.std::__uniq_ptr_impl.25"* %this, %"class.std::__uniq_ptr_impl.25"** %this.addr, align 8
  store %"class.std::__uniq_ptr_impl.25"* %__u, %"class.std::__uniq_ptr_impl.25"** %__u.addr, align 8
  %this1 = load %"class.std::__uniq_ptr_impl.25"*, %"class.std::__uniq_ptr_impl.25"** %this.addr, align 8
  %_M_t = getelementptr inbounds %"class.std::__uniq_ptr_impl.25", %"class.std::__uniq_ptr_impl.25"* %this1, i32 0, i32 0
  %0 = load %"class.std::__uniq_ptr_impl.25"*, %"class.std::__uniq_ptr_impl.25"** %__u.addr, align 8
  %_M_t2 = getelementptr inbounds %"class.std::__uniq_ptr_impl.25", %"class.std::__uniq_ptr_impl.25"* %0, i32 0, i32 0
  %call = call nonnull align 8 dereferenceable(8) %"class.std::tuple.26"* @_ZSt4moveIRSt5tupleIJPN10tensorflow7Variant14ValueInterfaceESt14default_deleteIS3_EEEEONSt16remove_referenceIT_E4typeEOSA_(%"class.std::tuple.26"* nonnull align 8 dereferenceable(8) %_M_t2) #11
  call void @_ZNSt5tupleIJPN10tensorflow7Variant14ValueInterfaceESt14default_deleteIS2_EEEC2EOS6_(%"class.std::tuple.26"* %_M_t, %"class.std::tuple.26"* nonnull align 8 dereferenceable(8) %call) #11
  %1 = load %"class.std::__uniq_ptr_impl.25"*, %"class.std::__uniq_ptr_impl.25"** %__u.addr, align 8
  %call3 = invoke nonnull align 8 dereferenceable(8) %"class.tensorflow::AbstractTensorInterface"** @_ZNSt15__uniq_ptr_implIN10tensorflow7Variant14ValueInterfaceESt14default_deleteIS2_EE6_M_ptrEv(%"class.std::__uniq_ptr_impl.25"* %1)
          to label %invoke.cont unwind label %terminate.lpad
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local nonnull align 8 dereferenceable(8) %"class.std::tuple.26"* @_ZSt4moveIRSt5tupleIJPN10tensorflow7Variant14ValueInterfaceESt14default_deleteIS3_EEEEONSt16remove_referenceIT_E4typeEOSA_(%"class.std::tuple.26"* nonnull align 8 dereferenceable(8) %__t) #0 comdat {
entry:
  %__t.addr = alloca %"class.std::tuple.26"*, align 8
  store %"class.std::tuple.26"* %__t, %"class.std::tuple.26"** %__t.addr, align 8
  %0 = load %"class.std::tuple.26"*, %"class.std::tuple.26"** %__t.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSt5tupleIJPN10tensorflow7Variant14ValueInterfaceESt14default_deleteIS2_EEEC2EOS6_(%"class.std::tuple.26"* %this, %"class.std::tuple.26"* nonnull align 8 dereferenceable(8) %0) unnamed_addr #0 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::tuple.26"*, align 8
  %.addr = alloca %"class.std::tuple.26"*, align 8
  store %"class.std::tuple.26"* %this, %"class.std::tuple.26"** %this.addr, align 8
  store %"class.std::tuple.26"* %0, %"class.std::tuple.26"** %.addr, align 8
  %this1 = load %"class.std::tuple.26"*, %"class.std::tuple.26"** %this.addr, align 8
  %1 = bitcast %"class.std::tuple.26"* %this1 to %"struct.std::_Tuple_impl.27"*
  %2 = load %"class.std::tuple.26"*, %"class.std::tuple.26"** %.addr, align 8
  %3 = bitcast %"class.std::tuple.26"* %2 to %"struct.std::_Tuple_impl.27"*
  call void @_ZNSt11_Tuple_implILm0EJPN10tensorflow7Variant14ValueInterfaceESt14default_deleteIS2_EEEC2EOS6_(%"struct.std::_Tuple_impl.27"* %1, %"struct.std::_Tuple_impl.27"* nonnull align 8 dereferenceable(8) %3) #11
  ret void
}

; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSt11_Tuple_implILm0EJPN10tensorflow7Variant14ValueInterfaceESt14default_deleteIS2_EEEC2EOS6_(%"struct.std::_Tuple_impl.27"* %this, %"struct.std::_Tuple_impl.27"* nonnull align 8 dereferenceable(8) %0) unnamed_addr #0 comdat align 2 {
entry:
  %this.addr = alloca %"struct.std::_Tuple_impl.27"*, align 8
  %.addr = alloca %"struct.std::_Tuple_impl.27"*, align 8
  store %"struct.std::_Tuple_impl.27"* %this, %"struct.std::_Tuple_impl.27"** %this.addr, align 8
  store %"struct.std::_Tuple_impl.27"* %0, %"struct.std::_Tuple_impl.27"** %.addr, align 8
  %this1 = load %"struct.std::_Tuple_impl.27"*, %"struct.std::_Tuple_impl.27"** %this.addr, align 8
  %1 = bitcast %"struct.std::_Tuple_impl.27"* %this1 to %"class.std::ios_base::Init"*
  %2 = load %"struct.std::_Tuple_impl.27"*, %"struct.std::_Tuple_impl.27"** %.addr, align 8
  %3 = bitcast %"struct.std::_Tuple_impl.27"* %2 to %"class.std::ios_base::Init"*
  ...
  %4 = bitcast %"struct.std::_Tuple_impl.27"* %this1 to %struct.TF_Tensor*
  %5 = load %"struct.std::_Tuple_impl.27"*, %"struct.std::_Tuple_impl.27"** %.addr, align 8
  %6 = bitcast %"struct.std::_Tuple_impl.27"* %5 to %struct.TF_Tensor*
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSt10unique_ptrIN10tensorflow7Variant14ValueInterfaceESt14default_deleteIS2_EE4swapERS5_(%"class.std::unique_ptr.23"* %this, %"class.std::unique_ptr.23"* nonnull align 8 dereferenceable(8) %__u) #0 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::unique_ptr.23"*, align 8
  %__u.addr = alloca %"class.std::unique_ptr.23"*, align 8
  store %"class.std::unique_ptr.23"* %this, %"class.std::unique_ptr.23"** %this.addr, align 8
  store %"class.std::unique_ptr.23"* %__u, %"class.std::unique_ptr.23"** %__u.addr, align 8
  %this1 = load %"class.std::unique_ptr.23"*, %"class.std::unique_ptr.23"** %this.addr, align 8
  %_M_t = getelementptr inbounds %"class.std::unique_ptr.23", %"class.std::unique_ptr.23"* %this1, i32 0, i32 0
  %0 = bitcast %"struct.std::__uniq_ptr_data.24"* %_M_t to %"class.std::__uniq_ptr_impl.25"*
  %1 = load %"class.std::unique_ptr.23"*, %"class.std::unique_ptr.23"** %__u.addr, align 8
  %_M_t2 = getelementptr inbounds %"class.std::unique_ptr.23", %"class.std::unique_ptr.23"* %1, i32 0, i32 0
  %2 = bitcast %"struct.std::__uniq_ptr_data.24"* %_M_t2 to %"class.std::__uniq_ptr_impl.25"*
  call void @_ZNSt15__uniq_ptr_implIN10tensorflow7Variant14ValueInterfaceESt14default_deleteIS2_EE4swapERS5_(%"class.std::__uniq_ptr_impl.25"* %0, %"class.std::__uniq_ptr_impl.25"* nonnull align 8 dereferenceable(8) %2) #11
  ret void
}

; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSt15__uniq_ptr_implIN10tensorflow7Variant14ValueInterfaceESt14default_deleteIS2_EE4swapERS5_(%"class.std::__uniq_ptr_impl.25"* %this, %"class.std::__uniq_ptr_impl.25"* nonnull align 8 dereferenceable(8) %__rhs) #0 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
  %this.addr = alloca %"class.std::__uniq_ptr_impl.25"*, align 8
  %__rhs.addr = alloca %"class.std::__uniq_ptr_impl.25"*, align 8
  store %"class.std::__uniq_ptr_impl.25"* %this, %"class.std::__uniq_ptr_impl.25"** %this.addr, align 8
  store %"class.std::__uniq_ptr_impl.25"* %__rhs, %"class.std::__uniq_ptr_impl.25"** %__rhs.addr, align 8
  %this1 = load %"class.std::__uniq_ptr_impl.25"*, %"class.std::__uniq_ptr_impl.25"** %this.addr, align 8
  %call = invoke nonnull align 8 dereferenceable(8) %"class.tensorflow::AbstractTensorInterface"** @_ZNSt15__uniq_ptr_implIN10tensorflow7Variant14ValueInterfaceESt14default_deleteIS2_EE6_M_ptrEv(%"class.std::__uniq_ptr_impl.25"* %this1)
          to label %invoke.cont unwind label %terminate.lpad

invoke.cont:                                      ; preds = %entry
  %0 = load %"class.std::__uniq_ptr_impl.25"*, %"class.std::__uniq_ptr_impl.25"** %__rhs.addr, align 8
  %call3 = invoke nonnull align 8 dereferenceable(8) %"class.tensorflow::AbstractTensorInterface"** @_ZNSt15__uniq_ptr_implIN10tensorflow7Variant14ValueInterfaceESt14default_deleteIS2_EE6_M_ptrEv(%"class.std::__uniq_ptr_impl.25"* %0)
          to label %invoke.cont2 unwind label %terminate.lpad
...
invoke.cont2:                                     ; preds = %invoke.cont
  ...
  %call5 = invoke nonnull align 1 dereferenceable(1) %"class.std::ios_base::Init"* @_ZNSt15__uniq_ptr_implIN10tensorflow7Variant14ValueInterfaceESt14default_deleteIS2_EE10_M_deleterEv(%"class.std::__uniq_ptr_impl.25"* %this1)
          to label %invoke.cont4 unwind label %terminate.lpad

invoke.cont4:                                     ; preds = %invoke.cont2
  %1 = load %"class.std::__uniq_ptr_impl.25"*, %"class.std::__uniq_ptr_impl.25"** %__rhs.addr, align 8
  %call7 = invoke nonnull align 1 dereferenceable(1) %"class.std::ios_base::Init"* @_ZNSt15__uniq_ptr_implIN10tensorflow7Variant14ValueInterfaceESt14default_deleteIS2_EE10_M_deleterEv(%"class.std::__uniq_ptr_impl.25"* %1)
          to label %invoke.cont6 unwind label %terminate.lpad
...
invoke.cont:                                      ; preds = %entry
  ...
  call void @_ZNSt10unique_ptrIN10tensorflow7Variant14ValueInterfaceESt14default_deleteIS2_EEC2IS4_vEEDn(%"class.std::unique_ptr.23"* %2, i8* null) #11
  %is_inline_ = getelementptr inbounds %"class.tensorflow::Variant", %"class.tensorflow::Variant"* %this1, i32 0, i32 1
  store i8 0, i8* %is_inline_, align 8
  ret void
...
if.else:                                          ; preds = %entry
  %1 = getelementptr inbounds %"class.tensorflow::Variant", %"class.tensorflow::Variant"* %this1, i32 0, i32 0
  %heap_value_ = bitcast %union.anon.22* %1 to %"class.std::unique_ptr.23"*
  call void @_ZNSt10unique_ptrIN10tensorflow7Variant14ValueInterfaceESt14default_deleteIS2_EED2Ev(%"class.std::unique_ptr.23"* %heap_value_) #11
  br label %if.end
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSt10unique_ptrIN10tensorflow7Variant14ValueInterfaceESt14default_deleteIS2_EEC2IS4_vEEDn(%"class.std::unique_ptr.23"* %this, i8* %0) unnamed_addr #0 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::unique_ptr.23"*, align 8
  %.addr = alloca i8*, align 8
  store %"class.std::unique_ptr.23"* %this, %"class.std::unique_ptr.23"** %this.addr, align 8
  ...
  %this1 = load %"class.std::unique_ptr.23"*, %"class.std::unique_ptr.23"** %this.addr, align 8
  %_M_t = getelementptr inbounds %"class.std::unique_ptr.23", %"class.std::unique_ptr.23"* %this1, i32 0, i32 0
  %1 = bitcast %"struct.std::__uniq_ptr_data.24"* %_M_t to i8*
  %2 = call i8* @memset(i8* %1, i32 0, i64 8)
  call void @_ZNSt15__uniq_ptr_dataIN10tensorflow7Variant14ValueInterfaceESt14default_deleteIS2_ELb1ELb1EECI2St15__uniq_ptr_implIS2_S4_EEv(%"struct.std::__uniq_ptr_data.24"* %_M_t) #11
  ret void
}

; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSt15__uniq_ptr_dataIN10tensorflow7Variant14ValueInterfaceESt14default_deleteIS2_ELb1ELb1EECI2St15__uniq_ptr_implIS2_S4_EEv(%"struct.std::__uniq_ptr_data.24"* %this) unnamed_addr #0 comdat align 2 {
entry:
  %this.addr = alloca %"struct.std::__uniq_ptr_data.24"*, align 8
  store %"struct.std::__uniq_ptr_data.24"* %this, %"struct.std::__uniq_ptr_data.24"** %this.addr, align 8
  %this1 = load %"struct.std::__uniq_ptr_data.24"*, %"struct.std::__uniq_ptr_data.24"** %this.addr, align 8
  %0 = bitcast %"struct.std::__uniq_ptr_data.24"* %this1 to %"class.std::__uniq_ptr_impl.25"*
  call void @_ZNSt15__uniq_ptr_implIN10tensorflow7Variant14ValueInterfaceESt14default_deleteIS2_EEC2Ev(%"class.std::__uniq_ptr_impl.25"* %0) #11
  ret void
}

; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSt15__uniq_ptr_implIN10tensorflow7Variant14ValueInterfaceESt14default_deleteIS2_EEC2Ev(%"class.std::__uniq_ptr_impl.25"* %this) unnamed_addr #0 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::__uniq_ptr_impl.25"*, align 8
  store %"class.std::__uniq_ptr_impl.25"* %this, %"class.std::__uniq_ptr_impl.25"** %this.addr, align 8
  %this1 = load %"class.std::__uniq_ptr_impl.25"*, %"class.std::__uniq_ptr_impl.25"** %this.addr, align 8
  %_M_t = getelementptr inbounds %"class.std::__uniq_ptr_impl.25", %"class.std::__uniq_ptr_impl.25"* %this1, i32 0, i32 0
  call void @_ZNSt5tupleIJPN10tensorflow7Variant14ValueInterfaceESt14default_deleteIS2_EEEC2ILb1ELb1EEEv(%"class.std::tuple.26"* %_M_t) #11
  ret void
}

; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSt5tupleIJPN10tensorflow7Variant14ValueInterfaceESt14default_deleteIS2_EEEC2ILb1ELb1EEEv(%"class.std::tuple.26"* %this) unnamed_addr #0 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
  %this.addr = alloca %"class.std::tuple.26"*, align 8
  store %"class.std::tuple.26"* %this, %"class.std::tuple.26"** %this.addr, align 8
  %this1 = load %"class.std::tuple.26"*, %"class.std::tuple.26"** %this.addr, align 8
  %0 = bitcast %"class.std::tuple.26"* %this1 to %"struct.std::_Tuple_impl.27"*
  invoke void @_ZNSt11_Tuple_implILm0EJPN10tensorflow7Variant14ValueInterfaceESt14default_deleteIS2_EEEC2Ev(%"struct.std::_Tuple_impl.27"* %0)
          to label %invoke.cont unwind label %terminate.lpad
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local void @_ZNSt11_Tuple_implILm0EJPN10tensorflow7Variant14ValueInterfaceESt14default_deleteIS2_EEEC2Ev(%"struct.std::_Tuple_impl.27"* %this) unnamed_addr #6 comdat align 2 {
entry:
  %this.addr = alloca %"struct.std::_Tuple_impl.27"*, align 8
  store %"struct.std::_Tuple_impl.27"* %this, %"struct.std::_Tuple_impl.27"** %this.addr, align 8
  %this1 = load %"struct.std::_Tuple_impl.27"*, %"struct.std::_Tuple_impl.27"** %this.addr, align 8
  %0 = bitcast %"struct.std::_Tuple_impl.27"* %this1 to %"class.std::ios_base::Init"*
  ...
  %1 = bitcast %"struct.std::_Tuple_impl.27"* %this1 to %struct.TF_Tensor*
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local nonnull align 8 dereferenceable(8) %"class.std::unique_ptr.23"* @_ZSt7forwardISt10unique_ptrIN10tensorflow7Variant14ValueInterfaceESt14default_deleteIS3_EEEOT_RNSt16remove_referenceIS7_E4typeE(%"class.std::unique_ptr.23"* nonnull align 8 dereferenceable(8) %__t) #0 comdat {
entry:
  %__t.addr = alloca %"class.std::unique_ptr.23"*, align 8
  store %"class.std::unique_ptr.23"* %__t, %"class.std::unique_ptr.23"** %__t.addr, align 8
  %0 = load %"class.std::unique_ptr.23"*, %"class.std::unique_ptr.23"** %__t.addr, align 8
...
if.else:                                          ; preds = %entry
  %1 = getelementptr inbounds %"class.tensorflow::Variant", %"class.tensorflow::Variant"* %this1, i32 0, i32 0
  %heap_value_ = bitcast %union.anon.22* %1 to %"class.std::unique_ptr.23"*
  %call3 = call %"class.tensorflow::AbstractTensorInterface"* @_ZNKSt10unique_ptrIN10tensorflow7Variant14ValueInterfaceESt14default_deleteIS2_EE3getEv(%"class.std::unique_ptr.23"* %heap_value_) #11
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local %"class.tensorflow::AbstractTensorInterface"* @_ZNKSt10unique_ptrIN10tensorflow7Variant14ValueInterfaceESt14default_deleteIS2_EE3getEv(%"class.std::unique_ptr.23"* %this) #0 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
  %this.addr = alloca %"class.std::unique_ptr.23"*, align 8
  store %"class.std::unique_ptr.23"* %this, %"class.std::unique_ptr.23"** %this.addr, align 8
  %this1 = load %"class.std::unique_ptr.23"*, %"class.std::unique_ptr.23"** %this.addr, align 8
  %_M_t = getelementptr inbounds %"class.std::unique_ptr.23", %"class.std::unique_ptr.23"* %this1, i32 0, i32 0
  %0 = bitcast %"struct.std::__uniq_ptr_data.24"* %_M_t to %"class.std::__uniq_ptr_impl.25"*
  %call = invoke %"class.tensorflow::AbstractTensorInterface"* @_ZNKSt15__uniq_ptr_implIN10tensorflow7Variant14ValueInterfaceESt14default_deleteIS2_EE6_M_ptrEv(%"class.std::__uniq_ptr_impl.25"* %0)
          to label %invoke.cont unwind label %terminate.lpad
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local %"class.tensorflow::AbstractTensorInterface"* @_ZNKSt15__uniq_ptr_implIN10tensorflow7Variant14ValueInterfaceESt14default_deleteIS2_EE6_M_ptrEv(%"class.std::__uniq_ptr_impl.25"* %this) #0 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::__uniq_ptr_impl.25"*, align 8
  store %"class.std::__uniq_ptr_impl.25"* %this, %"class.std::__uniq_ptr_impl.25"** %this.addr, align 8
  %this1 = load %"class.std::__uniq_ptr_impl.25"*, %"class.std::__uniq_ptr_impl.25"** %this.addr, align 8
  %_M_t = getelementptr inbounds %"class.std::__uniq_ptr_impl.25", %"class.std::__uniq_ptr_impl.25"* %this1, i32 0, i32 0
  %call = call nonnull align 8 dereferenceable(8) %"class.tensorflow::AbstractTensorInterface"** @_ZSt3getILm0EJPN10tensorflow7Variant14ValueInterfaceESt14default_deleteIS2_EEERKNSt13tuple_elementIXT_ESt5tupleIJDpT0_EEE4typeERKSA_(%"class.std::tuple.26"* nonnull align 8 dereferenceable(8) %_M_t) #11
  %0 = load %"class.tensorflow::AbstractTensorInterface"*, %"class.tensorflow::AbstractTensorInterface"** %call, align 8
  ret %"class.tensorflow::AbstractTensorInterface"* %0
}

; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local nonnull align 8 dereferenceable(8) %"class.tensorflow::AbstractTensorInterface"** @_ZSt3getILm0EJPN10tensorflow7Variant14ValueInterfaceESt14default_deleteIS2_EEERKNSt13tuple_elementIXT_ESt5tupleIJDpT0_EEE4typeERKSA_(%"class.std::tuple.26"* nonnull align 8 dereferenceable(8) %__t) #0 comdat {
entry:
  %__t.addr = alloca %"class.std::tuple.26"*, align 8
  store %"class.std::tuple.26"* %__t, %"class.std::tuple.26"** %__t.addr, align 8
  %0 = load %"class.std::tuple.26"*, %"class.std::tuple.26"** %__t.addr, align 8
  %1 = bitcast %"class.std::tuple.26"* %0 to %"struct.std::_Tuple_impl.27"*
  %call = call nonnull align 8 dereferenceable(8) %"class.tensorflow::AbstractTensorInterface"** @_ZSt12__get_helperILm0EPN10tensorflow7Variant14ValueInterfaceEJSt14default_deleteIS2_EEERKT0_RKSt11_Tuple_implIXT_EJS6_DpT1_EE(%"struct.std::_Tuple_impl.27"* nonnull align 8 dereferenceable(8) %1) #11
  ret %"class.tensorflow::AbstractTensorInterface"** %call
}
...
entry:
  ...
  store %"struct.std::_Tuple_impl.27"* %__t, %"struct.std::_Tuple_impl.27"** %__t.addr, align 8
  %0 = load %"struct.std::_Tuple_impl.27"*, %"struct.std::_Tuple_impl.27"** %__t.addr, align 8
  %call = call nonnull align 8 dereferenceable(8) %"class.tensorflow::AbstractTensorInterface"** @_ZNSt11_Tuple_implILm0EJPN10tensorflow7Variant14ValueInterfaceESt14default_deleteIS2_EEE7_M_headERKS6_(%"struct.std::_Tuple_impl.27"* nonnull align 8 dereferenceable(8) %0) #11
  ret %"class.tensorflow::AbstractTensorInterface"** %call
}

; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local nonnull align 8 dereferenceable(8) %"class.tensorflow::AbstractTensorInterface"** @_ZNSt11_Tuple_implILm0EJPN10tensorflow7Variant14ValueInterfaceESt14default_deleteIS2_EEE7_M_headERKS6_(%"struct.std::_Tuple_impl.27"* nonnull align 8 dereferenceable(8) %__t) #0 comdat align 2 {
entry:
  %__t.addr = alloca %"struct.std::_Tuple_impl.27"*, align 8
  store %"struct.std::_Tuple_impl.27"* %__t, %"struct.std::_Tuple_impl.27"** %__t.addr, align 8
  %0 = load %"struct.std::_Tuple_impl.27"*, %"struct.std::_Tuple_impl.27"** %__t.addr, align 8
...
entry:
  ...
  %value.addr = alloca %"class.tensorflow::Tensor"*, align 8
  %agg.tmp = alloca %"class.std::ios_base::Init", align 1
  %ref.tmp = alloca %"class.std::unique_ptr.55", align 8
...
if.else:                                          ; preds = %entry
  ...
  %heap_value_ = bitcast %union.anon.22* %4 to %"class.std::unique_ptr.23"*
  %5 = bitcast %"class.std::unique_ptr.23"* %heap_value_ to i8*
  %6 = bitcast i8* %5 to %"class.std::unique_ptr.23"*
  ...
  call void @_ZSt11make_uniqueIN10tensorflow7Variant5ValueINS0_6TensorEEEJNS1_10in_place_tES3_EENSt9_MakeUniqIT_E15__single_objectEDpOT0_(%"class.std::unique_ptr.55"* sret align 8 %ref.tmp, %"class.std::ios_base::Init"* nonnull align 1 dereferenceable(1) %ref.tmp3, %"class.tensorflow::Tensor"* nonnull align 8 dereferenceable(32) %call4)
  call void @_ZNSt10unique_ptrIN10tensorflow7Variant14ValueInterfaceESt14default_deleteIS2_EEC2INS1_5ValueINS0_6TensorEEES3_IS9_EvEEOS_IT_T0_E(%"class.std::unique_ptr.23"* %6, %"class.std::unique_ptr.55"* nonnull align 8 dereferenceable(8) %ref.tmp) #11
  call void @_ZNSt10unique_ptrIN10tensorflow7Variant5ValueINS0_6TensorEEESt14default_deleteIS4_EED2Ev(%"class.std::unique_ptr.55"* %ref.tmp) #11
  br label %if.end
...
entry:
  ...
  %exn.slot = alloca i8*, align 8
  %ehselector.slot = alloca i32, align 4
  %0 = bitcast %"class.std::unique_ptr.55"* %agg.result to i8*
  store i8* %0, i8** %result.ptr, align 8
...
invoke.cont:                                      ; preds = %entry
  call void @_ZNSt10unique_ptrIN10tensorflow7Variant5ValueINS0_6TensorEEESt14default_deleteIS4_EEC2IS6_vEEPS4_(%"class.std::unique_ptr.55"* %agg.result, %"class.tensorflow::TensorInterface"* %1) #11
  ret void
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSt10unique_ptrIN10tensorflow7Variant14ValueInterfaceESt14default_deleteIS2_EEC2INS1_5ValueINS0_6TensorEEES3_IS9_EvEEOS_IT_T0_E(%"class.std::unique_ptr.23"* %this, %"class.std::unique_ptr.55"* nonnull align 8 dereferenceable(8) %__u) unnamed_addr #0 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
  %this.addr = alloca %"class.std::unique_ptr.23"*, align 8
  %__u.addr = alloca %"class.std::unique_ptr.55"*, align 8
  store %"class.std::unique_ptr.23"* %this, %"class.std::unique_ptr.23"** %this.addr, align 8
  store %"class.std::unique_ptr.55"* %__u, %"class.std::unique_ptr.55"** %__u.addr, align 8
  %this1 = load %"class.std::unique_ptr.23"*, %"class.std::unique_ptr.23"** %this.addr, align 8
  %_M_t = getelementptr inbounds %"class.std::unique_ptr.23", %"class.std::unique_ptr.23"* %this1, i32 0, i32 0
  %0 = load %"class.std::unique_ptr.55"*, %"class.std::unique_ptr.55"** %__u.addr, align 8
  %call = call %"class.tensorflow::TensorInterface"* @_ZNSt10unique_ptrIN10tensorflow7Variant5ValueINS0_6TensorEEESt14default_deleteIS4_EE7releaseEv(%"class.std::unique_ptr.55"* %0) #11
  %1 = bitcast %"class.tensorflow::TensorInterface"* %call to %"class.tensorflow::AbstractTensorInterface"*
  %2 = load %"class.std::unique_ptr.55"*, %"class.std::unique_ptr.55"** %__u.addr, align 8
  %call2 = call nonnull align 1 dereferenceable(1) %"class.std::ios_base::Init"* @_ZNSt10unique_ptrIN10tensorflow7Variant5ValueINS0_6TensorEEESt14default_deleteIS4_EE11get_deleterEv(%"class.std::unique_ptr.55"* %2) #11
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSt10unique_ptrIN10tensorflow7Variant5ValueINS0_6TensorEEESt14default_deleteIS4_EED2Ev(%"class.std::unique_ptr.55"* %this) unnamed_addr #0 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
  %this.addr = alloca %"class.std::unique_ptr.55"*, align 8
  %__ptr = alloca %"class.tensorflow::TensorInterface"**, align 8
  store %"class.std::unique_ptr.55"* %this, %"class.std::unique_ptr.55"** %this.addr, align 8
  %this1 = load %"class.std::unique_ptr.55"*, %"class.std::unique_ptr.55"** %this.addr, align 8
  %_M_t = getelementptr inbounds %"class.std::unique_ptr.55", %"class.std::unique_ptr.55"* %this1, i32 0, i32 0
  %0 = bitcast %"struct.std::__uniq_ptr_data.56"* %_M_t to %"class.std::__uniq_ptr_impl.57"*
  %call = invoke nonnull align 8 dereferenceable(8) %"class.tensorflow::TensorInterface"** @_ZNSt15__uniq_ptr_implIN10tensorflow7Variant5ValueINS0_6TensorEEESt14default_deleteIS4_EE6_M_ptrEv(%"class.std::__uniq_ptr_impl.57"* %0)
          to label %invoke.cont unwind label %terminate.lpad
...
if.then:                                          ; preds = %invoke.cont
  %call2 = call nonnull align 1 dereferenceable(1) %"class.std::ios_base::Init"* @_ZNSt10unique_ptrIN10tensorflow7Variant5ValueINS0_6TensorEEESt14default_deleteIS4_EE11get_deleterEv(%"class.std::unique_ptr.55"* %this1) #11
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local nonnull align 8 dereferenceable(8) %"class.tensorflow::TensorInterface"** @_ZNSt15__uniq_ptr_implIN10tensorflow7Variant5ValueINS0_6TensorEEESt14default_deleteIS4_EE6_M_ptrEv(%"class.std::__uniq_ptr_impl.57"* %this) #0 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::__uniq_ptr_impl.57"*, align 8
  store %"class.std::__uniq_ptr_impl.57"* %this, %"class.std::__uniq_ptr_impl.57"** %this.addr, align 8
  %this1 = load %"class.std::__uniq_ptr_impl.57"*, %"class.std::__uniq_ptr_impl.57"** %this.addr, align 8
  %_M_t = getelementptr inbounds %"class.std::__uniq_ptr_impl.57", %"class.std::__uniq_ptr_impl.57"* %this1, i32 0, i32 0
  %call = call nonnull align 8 dereferenceable(8) %"class.tensorflow::TensorInterface"** @_ZSt3getILm0EJPN10tensorflow7Variant5ValueINS0_6TensorEEESt14default_deleteIS4_EEERNSt13tuple_elementIXT_ESt5tupleIJDpT0_EEE4typeERSC_(%"class.std::tuple.58"* nonnull align 8 dereferenceable(8) %_M_t) #11
  ret %"class.tensorflow::TensorInterface"** %call
}

; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local nonnull align 1 dereferenceable(1) %"class.std::ios_base::Init"* @_ZNSt10unique_ptrIN10tensorflow7Variant5ValueINS0_6TensorEEESt14default_deleteIS4_EE11get_deleterEv(%"class.std::unique_ptr.55"* %this) #0 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
  %this.addr = alloca %"class.std::unique_ptr.55"*, align 8
  store %"class.std::unique_ptr.55"* %this, %"class.std::unique_ptr.55"** %this.addr, align 8
  %this1 = load %"class.std::unique_ptr.55"*, %"class.std::unique_ptr.55"** %this.addr, align 8
  %_M_t = getelementptr inbounds %"class.std::unique_ptr.55", %"class.std::unique_ptr.55"* %this1, i32 0, i32 0
  %0 = bitcast %"struct.std::__uniq_ptr_data.56"* %_M_t to %"class.std::__uniq_ptr_impl.57"*
  %call = invoke nonnull align 1 dereferenceable(1) %"class.std::ios_base::Init"* @_ZNSt15__uniq_ptr_implIN10tensorflow7Variant5ValueINS0_6TensorEEESt14default_deleteIS4_EE10_M_deleterEv(%"class.std::__uniq_ptr_impl.57"* %0)
          to label %invoke.cont unwind label %terminate.lpad
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local void @_ZNK10tensorflow7Variant5ValueINS_6TensorEE5CloneEv(%"class.std::unique_ptr.23"* noalias sret align 8 %agg.result, %"class.tensorflow::TensorInterface"* %this) unnamed_addr #6 comdat align 2 {
entry:
  %result.ptr = alloca i8*, align 8
  %this.addr = alloca %"class.tensorflow::TensorInterface"*, align 8
  %ref.tmp = alloca %"class.std::unique_ptr.55", align 8
  %ref.tmp2 = alloca %"class.std::ios_base::Init", align 1
  %undef.agg.tmp = alloca %"class.std::ios_base::Init", align 1
  %0 = bitcast %"class.std::unique_ptr.23"* %agg.result to i8*
  store i8* %0, i8** %result.ptr, align 8
  store %"class.tensorflow::TensorInterface"* %this, %"class.tensorflow::TensorInterface"** %this.addr, align 8
  %this1 = load %"class.tensorflow::TensorInterface"*, %"class.tensorflow::TensorInterface"** %this.addr, align 8
  call void @_ZN10tensorflow7Variant7InPlaceEv()
  ...
  call void @_ZNSt10unique_ptrIN10tensorflow7Variant14ValueInterfaceESt14default_deleteIS2_EEC2INS1_5ValueINS0_6TensorEEES3_IS9_EvEEOS_IT_T0_E(%"class.std::unique_ptr.23"* %agg.result, %"class.std::unique_ptr.55"* nonnull align 8 dereferenceable(8) %ref.tmp) #11
  call void @_ZNSt10unique_ptrIN10tensorflow7Variant5ValueINS0_6TensorEEESt14default_deleteIS4_EED2Ev(%"class.std::unique_ptr.55"* %ref.tmp) #11
  ret void
}
...
entry:
  ...
  %ref.tmp6 = alloca %"class.absl::lts_20250127::log_internal::LogMessageFatal", align 8
  %cleanup.cond = alloca i1, align 1
  %ref.tmp11 = alloca i8*, align 8
  %ref.tmp12 = alloca %"class.std::basic_string_view", align 8
  %cleanup.cond14 = alloca i1, align 1
  %ref.tmp22 = alloca i8*, align 8
  ...
  store i1 false, i1* %cleanup.cond27, align 1
...
cond.false:                                       ; preds = %invoke.cont4
  invoke void @_ZN4absl12lts_2025012712log_internal15LogMessageFatalC1EPKciS4_(%"class.absl::lts_20250127::log_internal::LogMessageFatal"* %ref.tmp6, i8* getelementptr inbounds ([78 x i8], [78 x i8]* @.str.19, i64 0, i64 0), i32 353, i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str.20, i64 0, i64 0)) #22
          to label %invoke.cont7 unwind label %lpad3

invoke.cont7:                                     ; preds = %cond.false
  store i1 true, i1* %cleanup.cond, align 1
  %3 = bitcast %"class.absl::lts_20250127::log_internal::LogMessageFatal"* %ref.tmp6 to %"class.absl::lts_20250127::log_internal::LogMessage"*
  %call10 = invoke nonnull align 8 dereferenceable(16) %"class.absl::lts_20250127::log_internal::LogMessage"* @_ZN4absl12lts_2025012712log_internal10LogMessage14InternalStreamEv(%"class.absl::lts_20250127::log_internal::LogMessage"* %3)
          to label %invoke.cont9 unwind label %lpad8

invoke.cont9:                                     ; preds = %invoke.cont7
  invoke void @_ZNK10tensorflow7Variant5ValueINS_6TensorEE6TypeIdEv(%"class.std::basic_string_view"* sret align 8 %ref.tmp12, %"class.tensorflow::TensorInterface"* %this1)
          to label %invoke.cont13 unwind label %lpad8

invoke.cont13:                                    ; preds = %invoke.cont9
  store i1 true, i1* %cleanup.cond14, align 1
  %call17 = invoke i8* @_ZNK10tensorflow9TypeIndex4nameEv(%"class.std::basic_string_view"* %ref.tmp12)
          to label %invoke.cont16 unwind label %lpad15

invoke.cont16:                                    ; preds = %invoke.cont13
  store i8* %call17, i8** %ref.tmp11, align 8
  %call19 = invoke nonnull align 8 dereferenceable(16) %"class.absl::lts_20250127::log_internal::LogMessage"* @_ZN4absl12lts_2025012712log_internal10LogMessagelsIPKcLi0EEERS2_RKT_(%"class.absl::lts_20250127::log_internal::LogMessage"* %call10, i8** nonnull align 8 dereferenceable(8) %ref.tmp11)
          to label %invoke.cont18 unwind label %lpad15

invoke.cont18:                                    ; preds = %invoke.cont16
  %call21 = invoke nonnull align 8 dereferenceable(16) %"class.absl::lts_20250127::log_internal::LogMessage"* @_ZN4absl12lts_2025012712log_internal10LogMessagelsILi6EEERS2_RAT__Kc(%"class.absl::lts_20250127::log_internal::LogMessage"* %call19, [6 x i8]* nonnull align 1 dereferenceable(6) @.str.21)
          to label %invoke.cont20 unwind label %lpad15

invoke.cont20:                                    ; preds = %invoke.cont18
  %4 = load %"class.tensorflow::AbstractTensorInterface"*, %"class.tensorflow::AbstractTensorInterface"** %memory.addr, align 8
  %5 = bitcast %"class.tensorflow::AbstractTensorInterface"* %4 to void (%"class.std::basic_string_view"*, %"class.tensorflow::AbstractTensorInterface"*)***
  %vtable24 = load void (%"class.std::basic_string_view"*, %"class.tensorflow::AbstractTensorInterface"*)**, void (%"class.std::basic_string_view"*, %"class.tensorflow::AbstractTensorInterface"*)*** %5, align 8
  %vfn25 = getelementptr inbounds void (%"class.std::basic_string_view"*, %"class.tensorflow::AbstractTensorInterface"*)*, void (%"class.std::basic_string_view"*, %"class.tensorflow::AbstractTensorInterface"*)** %vtable24, i64 2
  %6 = load void (%"class.std::basic_string_view"*, %"class.tensorflow::AbstractTensorInterface"*)*, void (%"class.std::basic_string_view"*, %"class.tensorflow::AbstractTensorInterface"*)** %vfn25, align 8
  invoke void %6(%"class.std::basic_string_view"* sret align 8 %ref.tmp23, %"class.tensorflow::AbstractTensorInterface"* %4)
          to label %invoke.cont26 unwind label %lpad15

invoke.cont26:                                    ; preds = %invoke.cont20
  store i1 true, i1* %cleanup.cond27, align 1
  %call30 = invoke i8* @_ZNK10tensorflow9TypeIndex4nameEv(%"class.std::basic_string_view"* %ref.tmp23)
          to label %invoke.cont29 unwind label %lpad28

invoke.cont29:                                    ; preds = %invoke.cont26
  store i8* %call30, i8** %ref.tmp22, align 8
  %call32 = invoke nonnull align 8 dereferenceable(16) %"class.absl::lts_20250127::log_internal::LogMessage"* @_ZN4absl12lts_2025012712log_internal10LogMessagelsIPKcLi0EEERS2_RKT_(%"class.absl::lts_20250127::log_internal::LogMessage"* %call21, i8** nonnull align 8 dereferenceable(8) %ref.tmp22)
          to label %invoke.cont31 unwind label %lpad28

invoke.cont31:                                    ; preds = %invoke.cont29
  invoke void @_ZNKO4absl12lts_2025012712log_internal7VoidifyaaINS1_10LogMessageEEEvRKT_(%"class.std::ios_base::Init"* %ref.tmp5, %"class.absl::lts_20250127::log_internal::LogMessage"* nonnull align 8 dereferenceable(16) %call32)
...
cond.end:                                         ; preds = %invoke.cont33, %cond.true
  %cleanup.is_active = load i1, i1* %cleanup.cond27, align 1
  br i1 %cleanup.is_active, label %cleanup.action, label %cleanup.done

cleanup.action:                                   ; preds = %cond.end
  call void @_ZN10tensorflow9TypeIndexD2Ev(%"class.std::basic_string_view"* %ref.tmp23) #11
  br label %cleanup.done

cleanup.done:                                     ; preds = %cleanup.action, %cond.end
  %cleanup.is_active37 = load i1, i1* %cleanup.cond14, align 1
  br i1 %cleanup.is_active37, label %cleanup.action38, label %cleanup.done39

cleanup.action38:                                 ; preds = %cleanup.done
  call void @_ZN10tensorflow9TypeIndexD2Ev(%"class.std::basic_string_view"* %ref.tmp12) #11
  br label %cleanup.done39

cleanup.done39:                                   ; preds = %cleanup.action38, %cleanup.done
  %cleanup.is_active43 = load i1, i1* %cleanup.cond, align 1
  br i1 %cleanup.is_active43, label %cleanup.action44, label %cleanup.done45

cleanup.action44:                                 ; preds = %cleanup.done39
  call void @_ZN4absl12lts_2025012712log_internal15LogMessageFatalD1Ev(%"class.absl::lts_20250127::log_internal::LogMessageFatal"* %ref.tmp6) #16
  unreachable
...
lpad3:                                            ; preds = %cond.false, %invoke.cont
  %10 = landingpad { i8*, i32 }
          cleanup
  %11 = extractvalue { i8*, i32 } %10, 0
  store i8* %11, i8** %exn.slot, align 8
...
lpad15:                                           ; preds = %invoke.cont20, %invoke.cont18, %invoke.cont16, %invoke.cont13
  %16 = landingpad { i8*, i32 }
          cleanup
  %17 = extractvalue { i8*, i32 } %16, 0
  store i8* %17, i8** %exn.slot, align 8
...
lpad28:                                           ; preds = %invoke.cont31, %invoke.cont29, %invoke.cont26
  ...
  %21 = extractvalue { i8*, i32 } %19, 1
  store i32 %21, i32* %ehselector.slot, align 4
  %cleanup.is_active34 = load i1, i1* %cleanup.cond27, align 1
...
cleanup.done36:                                   ; preds = %cleanup.action35, %lpad28
  br label %ehcleanup

ehcleanup:                                        ; preds = %cleanup.done36, %lpad15
  %cleanup.is_active40 = load i1, i1* %cleanup.cond14, align 1
...
cleanup.done45:                                   ; preds = %22, %cleanup.done39
  call void @_ZN10tensorflow9TypeIndexD2Ev(%"class.std::basic_string_view"* %ref.tmp2) #11
  call void @_ZN10tensorflow9TypeIndexD2Ev(%"class.std::basic_string_view"* %ref.tmp) #11
  %value = getelementptr inbounds %"class.tensorflow::TensorInterface", %"class.tensorflow::TensorInterface"* %this1, i32 0, i32 1
  %call52 = call nonnull align 8 dereferenceable(32) %"class.tensorflow::Tensor"* @_ZSt4moveIRN10tensorflow6TensorEEONSt16remove_referenceIT_E4typeEOS4_(%"class.tensorflow::Tensor"* nonnull align 8 dereferenceable(32) %value) #11
  %23 = load %"class.tensorflow::AbstractTensorInterface"*, %"class.tensorflow::AbstractTensorInterface"** %memory.addr, align 8
  %24 = bitcast %"class.tensorflow::AbstractTensorInterface"* %23 to %"class.tensorflow::TensorInterface"*
  %value53 = getelementptr inbounds %"class.tensorflow::TensorInterface", %"class.tensorflow::TensorInterface"* %24, i32 0, i32 1
  %call54 = call nonnull align 8 dereferenceable(32) %"class.tensorflow::Tensor"* @_ZN10tensorflow6TensoraSEOS0_(%"class.tensorflow::Tensor"* %value53, %"class.tensorflow::Tensor"* nonnull align 8 dereferenceable(32) %call52)
  ret void

ehcleanup46:                                      ; preds = %cleanup.done42, %lpad8
  %cleanup.is_active47 = load i1, i1* %cleanup.cond, align 1
...
cleanup.done49:                                   ; preds = %25, %ehcleanup46
  br label %ehcleanup50

ehcleanup50:                                      ; preds = %cleanup.done49, %lpad3
  call void @_ZN10tensorflow9TypeIndexD2Ev(%"class.std::basic_string_view"* %ref.tmp2) #11
  br label %ehcleanup51
...
cond.false:                                       ; preds = %invoke.cont3
  invoke void @_ZN4absl12lts_2025012712log_internal15LogMessageFatalC1EPKciS4_(%"class.absl::lts_20250127::log_internal::LogMessageFatal"* %ref.tmp5, i8* getelementptr inbounds ([92 x i8], [92 x i8]* @.str.26, i64 0, i64 0), i32 243, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.27, i64 0, i64 0)) #22
          to label %invoke.cont6 unwind label %lpad

invoke.cont6:                                     ; preds = %cond.false
  store i1 true, i1* %cleanup.cond, align 1
  %3 = bitcast %"class.absl::lts_20250127::log_internal::LogMessageFatal"* %ref.tmp5 to %"class.absl::lts_20250127::log_internal::LogMessage"*
  %call = invoke nonnull align 8 dereferenceable(16) %"class.absl::lts_20250127::log_internal::LogMessage"* @_ZN4absl12lts_2025012712log_internal10LogMessage14InternalStreamEv(%"class.absl::lts_20250127::log_internal::LogMessage"* %3)
          to label %invoke.cont8 unwind label %lpad7

invoke.cont8:                                     ; preds = %invoke.cont6
  invoke void @_ZNKO4absl12lts_2025012712log_internal7VoidifyaaINS1_10LogMessageEEEvRKT_(%"class.std::ios_base::Init"* %ref.tmp4, %"class.absl::lts_20250127::log_internal::LogMessage"* nonnull align 8 dereferenceable(16) %call)
...
lpad:                                             ; preds = %cleanup.done, %cond.false, %invoke.cont, %entry
  %4 = landingpad { i8*, i32 }
          cleanup
  %5 = extractvalue { i8*, i32 } %4, 0
  store i8* %5, i8** %exn.slot, align 8
...
lpad7:                                            ; preds = %invoke.cont8, %invoke.cont6
  ...
  %12 = extractvalue { i8*, i32 } %10, 1
  store i32 %12, i32* %ehselector.slot, align 4
  %cleanup.is_active10 = load i1, i1* %cleanup.cond, align 1
...
cleanup.done:                                     ; preds = %13, %cond.end
  %14 = load %"class.std::__cxx11::basic_string"*, %"class.std::__cxx11::basic_string"** %buf.addr, align 8
  %call14 = invoke zeroext i1 @_ZN10tensorflow17VariantTensorData17SerializeToStringEPNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE(%"class.tensorflow::VariantTensorData"* %data, %"class.std::__cxx11::basic_string"* %14)
          to label %invoke.cont13 unwind label %lpad
...
cleanup.done12:                                   ; preds = %15, %lpad7
  br label %ehcleanup

ehcleanup:                                        ; preds = %cleanup.done12, %lpad2, %lpad
  call void @_ZN10tensorflow17VariantTensorDataD2Ev(%"class.tensorflow::VariantTensorData"* %data) #11
  br label %eh.resume
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local nonnull align 8 dereferenceable(16) %"class.absl::lts_20250127::log_internal::LogMessage"* @_ZN4absl12lts_2025012712log_internal10LogMessagelsIPKcLi0EEERS2_RKT_(%"class.absl::lts_20250127::log_internal::LogMessage"* %this, i8** nonnull align 8 dereferenceable(8) %v) #6 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
  %this.addr = alloca %"class.absl::lts_20250127::log_internal::LogMessage"*, align 8
  %v.addr = alloca i8**, align 8
  %view = alloca %"class.absl::lts_20250127::log_internal::LogMessage::OstreamView", align 8
  %exn.slot = alloca i8*, align 8
  %ehselector.slot = alloca i32, align 4
  %ref.tmp = alloca %"class.std::ios_base::Init", align 1
  store %"class.absl::lts_20250127::log_internal::LogMessage"* %this, %"class.absl::lts_20250127::log_internal::LogMessage"** %this.addr, align 8
  ...
  %this1 = load %"class.absl::lts_20250127::log_internal::LogMessage"*, %"class.absl::lts_20250127::log_internal::LogMessage"** %this.addr, align 8
  %data_ = getelementptr inbounds %"class.absl::lts_20250127::log_internal::LogMessage", %"class.absl::lts_20250127::log_internal::LogMessage"* %this1, i32 0, i32 1
  %call = call nonnull align 1 %"struct.absl::lts_20250127::log_internal::LogMessage::LogMessageData"* @_ZNKSt10unique_ptrIN4absl12lts_2025012712log_internal10LogMessage14LogMessageDataESt14default_deleteIS4_EEdeEv(%"class.std::unique_ptr"* %data_)
  call void @_ZN4absl12lts_2025012712log_internal10LogMessage11OstreamViewC1ERNS2_14LogMessageDataE(%"class.absl::lts_20250127::log_internal::LogMessage::OstreamView"* %view, %"struct.absl::lts_20250127::log_internal::LogMessage::LogMessageData"* nonnull align 1 %call)
  %call2 = invoke nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZN4absl12lts_2025012712log_internal10LogMessage11OstreamView6streamEv(%"class.absl::lts_20250127::log_internal::LogMessage::OstreamView"* %view)
          to label %invoke.cont unwind label %lpad

invoke.cont:                                      ; preds = %entry
  %0 = load i8**, i8*** %v.addr, align 8
  %1 = load i8*, i8** %0, align 8
  %call4 = invoke i8* @_ZN4absl12lts_2025012712log_internal9NullGuardIPKcE5GuardES4_(i8* %1)
          to label %invoke.cont3 unwind label %lpad

invoke.cont3:                                     ; preds = %invoke.cont
  %call6 = invoke nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* nonnull align 8 dereferenceable(8) %call2, i8* %call4)
          to label %invoke.cont5 unwind label %lpad

invoke.cont5:                                     ; preds = %invoke.cont3
  call void @_ZN4absl12lts_2025012712log_internal10LogMessage11OstreamViewD1Ev(%"class.absl::lts_20250127::log_internal::LogMessage::OstreamView"* %view) #11
  ret %"class.absl::lts_20250127::log_internal::LogMessage"* %this1
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local nonnull align 8 dereferenceable(16) %"class.absl::lts_20250127::log_internal::LogMessage"* @_ZN4absl12lts_2025012712log_internal10LogMessagelsILi6EEERS2_RAT__Kc(%"class.absl::lts_20250127::log_internal::LogMessage"* %this, [6 x i8]* nonnull align 1 dereferenceable(6) %buf) #6 comdat align 2 {
entry:
  %this.addr = alloca %"class.absl::lts_20250127::log_internal::LogMessage"*, align 8
  %buf.addr = alloca [6 x i8]*, align 8
  %agg.tmp = alloca %"class.std::basic_string_view", align 8
  store %"class.absl::lts_20250127::log_internal::LogMessage"* %this, %"class.absl::lts_20250127::log_internal::LogMessage"** %this.addr, align 8
  store [6 x i8]* %buf, [6 x i8]** %buf.addr, align 8
  %this1 = load %"class.absl::lts_20250127::log_internal::LogMessage"*, %"class.absl::lts_20250127::log_internal::LogMessage"** %this.addr, align 8
  %0 = load [6 x i8]*, [6 x i8]** %buf.addr, align 8
  %arraydecay = getelementptr inbounds [6 x i8], [6 x i8]* %0, i64 0, i64 0
  call void @_ZNSt17basic_string_viewIcSt11char_traitsIcEEC2EPKc(%"class.std::basic_string_view"* %agg.tmp, i8* %arraydecay) #11
  %1 = bitcast %"class.std::basic_string_view"* %agg.tmp to { i64, i8* }*
  %2 = getelementptr inbounds { i64, i8* }, { i64, i8* }* %1, i32 0, i32 0
  %3 = load i64, i64* %2, align 8
  %4 = getelementptr inbounds { i64, i8* }, { i64, i8* }* %1, i32 0, i32 1
  %5 = load i8*, i8** %4, align 8
  call void @_ZN4absl12lts_2025012712log_internal10LogMessage19CopyToEncodedBufferILNS2_10StringTypeE0EEEvSt17basic_string_viewIcSt11char_traitsIcEE(%"class.absl::lts_20250127::log_internal::LogMessage"* %this1, i64 %3, i8* %5)
  ret %"class.absl::lts_20250127::log_internal::LogMessage"* %this1
}
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSt17basic_string_viewIcSt11char_traitsIcEEC2EPKc(%"class.std::basic_string_view"* %this, i8* nonnull %__str) unnamed_addr #0 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
  %this.addr = alloca %"class.std::basic_string_view"*, align 8
  ...
  %this1 = load %"class.std::basic_string_view"*, %"class.std::basic_string_view"** %this.addr, align 8
  %_M_len = getelementptr inbounds %"class.std::basic_string_view", %"class.std::basic_string_view"* %this1, i32 0, i32 0
  %0 = load i8*, i8** %__str.addr, align 8
  %call = invoke i64 @_ZNSt11char_traitsIcE6lengthEPKc(i8* %0)
          to label %invoke.cont unwind label %terminate.lpad

invoke.cont:                                      ; preds = %entry
  store i64 %call, i64* %_M_len, align 8
  %_M_str = getelementptr inbounds %"class.std::basic_string_view", %"class.std::basic_string_view"* %this1, i32 0, i32 1
  %1 = load i8*, i8** %__str.addr, align 8
  store i8* %1, i8** %_M_str, align 8
  ret void
...
declare dso_local void @_ZN4absl12lts_2025012712log_internal10LogMessage19CopyToEncodedBufferILNS2_10StringTypeE0EEEvSt17basic_string_viewIcSt11char_traitsIcEE(%"class.absl::lts_20250127::log_internal::LogMessage"*, i64, i8*) #4

; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local nonnull align 1 %"struct.absl::lts_20250127::log_internal::LogMessage::LogMessageData"* @_ZNKSt10unique_ptrIN4absl12lts_2025012712log_internal10LogMessage14LogMessageDataESt14default_deleteIS4_EEdeEv(%"class.std::unique_ptr"* %this) #0 comdat align 2 {
entry:
...
do.end:                                           ; preds = %do.body
  %call = call %"struct.absl::lts_20250127::log_internal::LogMessage::LogMessageData"* @_ZNKSt10unique_ptrIN4absl12lts_2025012712log_internal10LogMessage14LogMessageDataESt14default_deleteIS4_EE3getEv(%"class.std::unique_ptr"* %this1) #11
  ret %"struct.absl::lts_20250127::log_internal::LogMessage::LogMessageData"* %call
}

declare dso_local void @_ZN4absl12lts_2025012712log_internal10LogMessage11OstreamViewC1ERNS2_14LogMessageDataE(%"class.absl::lts_20250127::log_internal::LogMessage::OstreamView"*, %"struct.absl::lts_20250127::log_internal::LogMessage::LogMessageData"* nonnull align 1) unnamed_addr #4

declare dso_local nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZN4absl12lts_2025012712log_internal10LogMessage11OstreamView6streamEv(%"class.absl::lts_20250127::log_internal::LogMessage::OstreamView"*) #4

; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local i8* @_ZN4absl12lts_2025012712log_internal9NullGuardIPKcE5GuardES4_(i8* %v) #0 comdat align 2 {
entry:
  %v.addr = alloca i8*, align 8
  store i8* %v, i8** %v.addr, align 8
  %0 = load i8*, i8** %v.addr, align 8
...
cond.false:                                       ; preds = %entry
  %call = call i8* @_ZNKSt5arrayIcLm7EE4dataEv(%"struct.std::array"* @_ZN4absl12lts_2025012712log_internal9kCharNullE) #11
  br label %cond.end
...
; Function Attrs: nounwind
declare dso_local void @_ZN4absl12lts_2025012712log_internal10LogMessage11OstreamViewD1Ev(%"class.absl::lts_20250127::log_internal::LogMessage::OstreamView"*) unnamed_addr #3

; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local i8* @_ZNKSt5arrayIcLm7EE4dataEv(%"struct.std::array"* %this) #0 comdat align 2 {
entry:
  ...
  %call = call i8* @_ZNSt14__array_traitsIcLm7EE6_S_ptrERA7_Kc([7 x i8]* nonnull align 1 dereferenceable(7) %_M_elems) #11
  ret i8* %call
}

; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local i8* @_ZNSt14__array_traitsIcLm7EE6_S_ptrERA7_Kc([7 x i8]* nonnull align 1 dereferenceable(7) %__t) #0 comdat align 2 {
entry:
  %__t.addr = alloca [7 x i8]*, align 8
  store [7 x i8]* %__t, [7 x i8]** %__t.addr, align 8
  %0 = load [7 x i8]*, [7 x i8]** %__t.addr, align 8
  %arraydecay = getelementptr inbounds [7 x i8], [7 x i8]* %0, i64 0, i64 0
  ret i8* %arraydecay
}

; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local %"struct.absl::lts_20250127::log_internal::LogMessage::LogMessageData"* @_ZNKSt10unique_ptrIN4absl12lts_2025012712log_internal10LogMessage14LogMessageDataESt14default_deleteIS4_EE3getEv(%"class.std::unique_ptr"* %this) #0 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
  %this.addr = alloca %"class.std::unique_ptr"*, align 8
  store %"class.std::unique_ptr"* %this, %"class.std::unique_ptr"** %this.addr, align 8
  %this1 = load %"class.std::unique_ptr"*, %"class.std::unique_ptr"** %this.addr, align 8
  ...
  %call = invoke %"struct.absl::lts_20250127::log_internal::LogMessage::LogMessageData"* @_ZNKSt15__uniq_ptr_implIN4absl12lts_2025012712log_internal10LogMessage14LogMessageDataESt14default_deleteIS4_EE6_M_ptrEv(%"class.std::__uniq_ptr_impl"* %0)
          to label %invoke.cont unwind label %terminate.lpad
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local %"struct.absl::lts_20250127::log_internal::LogMessage::LogMessageData"* @_ZNKSt15__uniq_ptr_implIN4absl12lts_2025012712log_internal10LogMessage14LogMessageDataESt14default_deleteIS4_EE6_M_ptrEv(%"class.std::__uniq_ptr_impl"* %this) #0 comdat align 2 {
entry:
  ...
  %call = call nonnull align 8 dereferenceable(8) %"struct.absl::lts_20250127::log_internal::LogMessage::LogMessageData"** @_ZSt3getILm0EJPN4absl12lts_2025012712log_internal10LogMessage14LogMessageDataESt14default_deleteIS4_EEERKNSt13tuple_elementIXT_ESt5tupleIJDpT0_EEE4typeERKSC_(%"class.std::tuple"* nonnull align 8 dereferenceable(8) %_M_t) #11
  %0 = load %"struct.absl::lts_20250127::log_internal::LogMessage::LogMessageData"*, %"struct.absl::lts_20250127::log_internal::LogMessage::LogMessageData"** %call, align 8
  ret %"struct.absl::lts_20250127::log_internal::LogMessage::LogMessageData"* %0
}

; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local nonnull align 8 dereferenceable(8) %"struct.absl::lts_20250127::log_internal::LogMessage::LogMessageData"** @_ZSt3getILm0EJPN4absl12lts_2025012712log_internal10LogMessage14LogMessageDataESt14default_deleteIS4_EEERKNSt13tuple_elementIXT_ESt5tupleIJDpT0_EEE4typeERKSC_(%"class.std::tuple"* nonnull align 8 dereferenceable(8) %__t) #0 comdat {
entry:
  ...
  %call = call nonnull align 8 dereferenceable(8) %"struct.absl::lts_20250127::log_internal::LogMessage::LogMessageData"** @_ZSt12__get_helperILm0EPN4absl12lts_2025012712log_internal10LogMessage14LogMessageDataEJSt14default_deleteIS4_EEERKT0_RKSt11_Tuple_implIXT_EJS8_DpT1_EE(%"struct.std::_Tuple_impl"* nonnull align 8 dereferenceable(8) %1) #11
  ret %"struct.absl::lts_20250127::log_internal::LogMessage::LogMessageData"** %call
}
...
entry:
  ...
  %call = call nonnull align 8 dereferenceable(8) %"struct.absl::lts_20250127::log_internal::LogMessage::LogMessageData"** @_ZNSt11_Tuple_implILm0EJPN4absl12lts_2025012712log_internal10LogMessage14LogMessageDataESt14default_deleteIS4_EEE7_M_headERKS8_(%"struct.std::_Tuple_impl"* nonnull align 8 dereferenceable(8) %0) #11
  ret %"struct.absl::lts_20250127::log_internal::LogMessage::LogMessageData"** %call
}

; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local nonnull align 8 dereferenceable(8) %"struct.absl::lts_20250127::log_internal::LogMessage::LogMessageData"** @_ZNSt11_Tuple_implILm0EJPN4absl12lts_2025012712log_internal10LogMessage14LogMessageDataESt14default_deleteIS4_EEE7_M_headERKS8_(%"struct.std::_Tuple_impl"* nonnull align 8 dereferenceable(8) %__t) #0 comdat align 2 {
entry:
  %__t.addr = alloca %"struct.std::_Tuple_impl"*, align 8
  store %"struct.std::_Tuple_impl"* %__t, %"struct.std::_Tuple_impl"** %__t.addr, align 8
  %0 = load %"struct.std::_Tuple_impl"*, %"struct.std::_Tuple_impl"** %__t.addr, align 8
  %1 = bitcast %"struct.std::_Tuple_impl"* %0 to %"struct.std::_Head_base.7"*
  %call = call nonnull align 8 dereferenceable(8) %"struct.absl::lts_20250127::log_internal::LogMessage::LogMessageData"** @_ZNSt10_Head_baseILm0EPN4absl12lts_2025012712log_internal10LogMessage14LogMessageDataELb0EE7_M_headERKS6_(%"struct.std::_Head_base.7"* nonnull align 8 dereferenceable(8) %1) #11
  ret %"struct.absl::lts_20250127::log_internal::LogMessage::LogMessageData"** %call
}

; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local nonnull align 8 dereferenceable(8) %"struct.absl::lts_20250127::log_internal::LogMessage::LogMessageData"** @_ZNSt10_Head_baseILm0EPN4absl12lts_2025012712log_internal10LogMessage14LogMessageDataELb0EE7_M_headERKS6_(%"struct.std::_Head_base.7"* nonnull align 8 dereferenceable(8) %__b) #0 comdat align 2 {
entry:
  %__b.addr = alloca %"struct.std::_Head_base.7"*, align 8
  store %"struct.std::_Head_base.7"* %__b, %"struct.std::_Head_base.7"** %__b.addr, align 8
  %0 = load %"struct.std::_Head_base.7"*, %"struct.std::_Head_base.7"** %__b.addr, align 8
  %_M_head_impl = getelementptr inbounds %"struct.std::_Head_base.7", %"struct.std::_Head_base.7"* %0, i32 0, i32 0
  ret %"struct.absl::lts_20250127::log_internal::LogMessage::LogMessageData"** %_M_head_impl
}
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSt10unique_ptrIN10tensorflow7Variant5ValueINS0_6TensorEEESt14default_deleteIS4_EEC2IS6_vEEPS4_(%"class.std::unique_ptr.55"* %this, %"class.tensorflow::TensorInterface"* %__p) unnamed_addr #0 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
  %this.addr = alloca %"class.std::unique_ptr.55"*, align 8
  ...
  invoke void @_ZNSt15__uniq_ptr_dataIN10tensorflow7Variant5ValueINS0_6TensorEEESt14default_deleteIS4_ELb1ELb1EECI2St15__uniq_ptr_implIS4_S6_EEPS4_(%"struct.std::__uniq_ptr_data.56"* %_M_t, %"class.tensorflow::TensorInterface"* %0)
          to label %invoke.cont unwind label %terminate.lpad
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local void @_ZNSt15__uniq_ptr_dataIN10tensorflow7Variant5ValueINS0_6TensorEEESt14default_deleteIS4_ELb1ELb1EECI2St15__uniq_ptr_implIS4_S6_EEPS4_(%"struct.std::__uniq_ptr_data.56"* %this, %"class.tensorflow::TensorInterface"* %0) unnamed_addr #6 comdat align 2 {
entry:
  %this.addr = alloca %"struct.std::__uniq_ptr_data.56"*, align 8
  %.addr = alloca %"class.tensorflow::TensorInterface"*, align 8
  store %"struct.std::__uniq_ptr_data.56"* %this, %"struct.std::__uniq_ptr_data.56"** %this.addr, align 8
  store %"class.tensorflow::TensorInterface"* %0, %"class.tensorflow::TensorInterface"** %.addr, align 8
  %this1 = load %"struct.std::__uniq_ptr_data.56"*, %"struct.std::__uniq_ptr_data.56"** %this.addr, align 8
  %1 = bitcast %"struct.std::__uniq_ptr_data.56"* %this1 to %"class.std::__uniq_ptr_impl.57"*
  %2 = load %"class.tensorflow::TensorInterface"*, %"class.tensorflow::TensorInterface"** %.addr, align 8
  call void @_ZNSt15__uniq_ptr_implIN10tensorflow7Variant5ValueINS0_6TensorEEESt14default_deleteIS4_EEC2EPS4_(%"class.std::__uniq_ptr_impl.57"* %1, %"class.tensorflow::TensorInterface"* %2)
  ret void
}

; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local void @_ZNSt15__uniq_ptr_implIN10tensorflow7Variant5ValueINS0_6TensorEEESt14default_deleteIS4_EEC2EPS4_(%"class.std::__uniq_ptr_impl.57"* %this, %"class.tensorflow::TensorInterface"* %__p) unnamed_addr #6 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::__uniq_ptr_impl.57"*, align 8
  %__p.addr = alloca %"class.tensorflow::TensorInterface"*, align 8
  store %"class.std::__uniq_ptr_impl.57"* %this, %"class.std::__uniq_ptr_impl.57"** %this.addr, align 8
  ...
  %this1 = load %"class.std::__uniq_ptr_impl.57"*, %"class.std::__uniq_ptr_impl.57"** %this.addr, align 8
  %_M_t = getelementptr inbounds %"class.std::__uniq_ptr_impl.57", %"class.std::__uniq_ptr_impl.57"* %this1, i32 0, i32 0
  call void @_ZNSt5tupleIJPN10tensorflow7Variant5ValueINS0_6TensorEEESt14default_deleteIS4_EEEC2ILb1ELb1EEEv(%"class.std::tuple.58"* %_M_t) #11
  %0 = load %"class.tensorflow::TensorInterface"*, %"class.tensorflow::TensorInterface"** %__p.addr, align 8
  %call = call nonnull align 8 dereferenceable(8) %"class.tensorflow::TensorInterface"** @_ZNSt15__uniq_ptr_implIN10tensorflow7Variant5ValueINS0_6TensorEEESt14default_deleteIS4_EE6_M_ptrEv(%"class.std::__uniq_ptr_impl.57"* %this1)
  store %"class.tensorflow::TensorInterface"* %0, %"class.tensorflow::TensorInterface"** %call, align 8
  ret void
}

; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSt5tupleIJPN10tensorflow7Variant5ValueINS0_6TensorEEESt14default_deleteIS4_EEEC2ILb1ELb1EEEv(%"class.std::tuple.58"* %this) unnamed_addr #0 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
  %this.addr = alloca %"class.std::tuple.58"*, align 8
  store %"class.std::tuple.58"* %this, %"class.std::tuple.58"** %this.addr, align 8
  %this1 = load %"class.std::tuple.58"*, %"class.std::tuple.58"** %this.addr, align 8
  %0 = bitcast %"class.std::tuple.58"* %this1 to %"struct.std::_Tuple_impl.59"*
  invoke void @_ZNSt11_Tuple_implILm0EJPN10tensorflow7Variant5ValueINS0_6TensorEEESt14default_deleteIS4_EEEC2Ev(%"struct.std::_Tuple_impl.59"* %0)
          to label %invoke.cont unwind label %terminate.lpad
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local void @_ZNSt11_Tuple_implILm0EJPN10tensorflow7Variant5ValueINS0_6TensorEEESt14default_deleteIS4_EEEC2Ev(%"struct.std::_Tuple_impl.59"* %this) unnamed_addr #6 comdat align 2 {
entry:
  %this.addr = alloca %"struct.std::_Tuple_impl.59"*, align 8
  store %"struct.std::_Tuple_impl.59"* %this, %"struct.std::_Tuple_impl.59"** %this.addr, align 8
  %this1 = load %"struct.std::_Tuple_impl.59"*, %"struct.std::_Tuple_impl.59"** %this.addr, align 8
  %0 = bitcast %"struct.std::_Tuple_impl.59"* %this1 to %"class.std::ios_base::Init"*
  ...
  %1 = bitcast %"struct.std::_Tuple_impl.59"* %this1 to %"struct.std::_Head_base.62"*
  call void @_ZNSt10_Head_baseILm0EPN10tensorflow7Variant5ValueINS0_6TensorEEELb0EEC2Ev(%"struct.std::_Head_base.62"* %1)
  ret void
}
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSt10_Head_baseILm0EPN10tensorflow7Variant5ValueINS0_6TensorEEELb0EEC2Ev(%"struct.std::_Head_base.62"* %this) unnamed_addr #0 comdat align 2 {
entry:
  %this.addr = alloca %"struct.std::_Head_base.62"*, align 8
  store %"struct.std::_Head_base.62"* %this, %"struct.std::_Head_base.62"** %this.addr, align 8
  %this1 = load %"struct.std::_Head_base.62"*, %"struct.std::_Head_base.62"** %this.addr, align 8
  %_M_head_impl = getelementptr inbounds %"struct.std::_Head_base.62", %"struct.std::_Head_base.62"* %this1, i32 0, i32 0
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local nonnull align 1 dereferenceable(1) %"class.std::ios_base::Init"* @_ZNSt15__uniq_ptr_implIN10tensorflow7Variant5ValueINS0_6TensorEEESt14default_deleteIS4_EE10_M_deleterEv(%"class.std::__uniq_ptr_impl.57"* %this) #0 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::__uniq_ptr_impl.57"*, align 8
  store %"class.std::__uniq_ptr_impl.57"* %this, %"class.std::__uniq_ptr_impl.57"** %this.addr, align 8
  %this1 = load %"class.std::__uniq_ptr_impl.57"*, %"class.std::__uniq_ptr_impl.57"** %this.addr, align 8
  %_M_t = getelementptr inbounds %"class.std::__uniq_ptr_impl.57", %"class.std::__uniq_ptr_impl.57"* %this1, i32 0, i32 0
  %call = call nonnull align 1 dereferenceable(1) %"class.std::ios_base::Init"* @_ZSt3getILm1EJPN10tensorflow7Variant5ValueINS0_6TensorEEESt14default_deleteIS4_EEERNSt13tuple_elementIXT_ESt5tupleIJDpT0_EEE4typeERSC_(%"class.std::tuple.58"* nonnull align 8 dereferenceable(8) %_M_t) #11
  ret %"class.std::ios_base::Init"* %call
}

; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local nonnull align 1 dereferenceable(1) %"class.std::ios_base::Init"* @_ZSt3getILm1EJPN10tensorflow7Variant5ValueINS0_6TensorEEESt14default_deleteIS4_EEERNSt13tuple_elementIXT_ESt5tupleIJDpT0_EEE4typeERSC_(%"class.std::tuple.58"* nonnull align 8 dereferenceable(8) %__t) #0 comdat {
entry:
  %__t.addr = alloca %"class.std::tuple.58"*, align 8
  store %"class.std::tuple.58"* %__t, %"class.std::tuple.58"** %__t.addr, align 8
  %0 = load %"class.std::tuple.58"*, %"class.std::tuple.58"** %__t.addr, align 8
  %1 = bitcast %"class.std::tuple.58"* %0 to %"class.std::ios_base::Init"*
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local nonnull align 8 dereferenceable(8) %"class.tensorflow::TensorInterface"** @_ZSt3getILm0EJPN10tensorflow7Variant5ValueINS0_6TensorEEESt14default_deleteIS4_EEERNSt13tuple_elementIXT_ESt5tupleIJDpT0_EEE4typeERSC_(%"class.std::tuple.58"* nonnull align 8 dereferenceable(8) %__t) #0 comdat {
entry:
  %__t.addr = alloca %"class.std::tuple.58"*, align 8
  store %"class.std::tuple.58"* %__t, %"class.std::tuple.58"** %__t.addr, align 8
  %0 = load %"class.std::tuple.58"*, %"class.std::tuple.58"** %__t.addr, align 8
  %1 = bitcast %"class.std::tuple.58"* %0 to %"struct.std::_Tuple_impl.59"*
  %call = call nonnull align 8 dereferenceable(8) %"class.tensorflow::TensorInterface"** @_ZSt12__get_helperILm0EPN10tensorflow7Variant5ValueINS0_6TensorEEEJSt14default_deleteIS4_EEERT0_RSt11_Tuple_implIXT_EJS8_DpT1_EE(%"struct.std::_Tuple_impl.59"* nonnull align 8 dereferenceable(8) %1) #11
  ret %"class.tensorflow::TensorInterface"** %call
}

; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local nonnull align 8 dereferenceable(8) %"class.tensorflow::TensorInterface"** @_ZSt12__get_helperILm0EPN10tensorflow7Variant5ValueINS0_6TensorEEEJSt14default_deleteIS4_EEERT0_RSt11_Tuple_implIXT_EJS8_DpT1_EE(%"struct.std::_Tuple_impl.59"* nonnull align 8 dereferenceable(8) %__t) #0 comdat {
entry:
  %__t.addr = alloca %"struct.std::_Tuple_impl.59"*, align 8
  store %"struct.std::_Tuple_impl.59"* %__t, %"struct.std::_Tuple_impl.59"** %__t.addr, align 8
  %0 = load %"struct.std::_Tuple_impl.59"*, %"struct.std::_Tuple_impl.59"** %__t.addr, align 8
  %call = call nonnull align 8 dereferenceable(8) %"class.tensorflow::TensorInterface"** @_ZNSt11_Tuple_implILm0EJPN10tensorflow7Variant5ValueINS0_6TensorEEESt14default_deleteIS4_EEE7_M_headERS8_(%"struct.std::_Tuple_impl.59"* nonnull align 8 dereferenceable(8) %0) #11
  ret %"class.tensorflow::TensorInterface"** %call
}

; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local nonnull align 8 dereferenceable(8) %"class.tensorflow::TensorInterface"** @_ZNSt11_Tuple_implILm0EJPN10tensorflow7Variant5ValueINS0_6TensorEEESt14default_deleteIS4_EEE7_M_headERS8_(%"struct.std::_Tuple_impl.59"* nonnull align 8 dereferenceable(8) %__t) #0 comdat align 2 {
entry:
  %__t.addr = alloca %"struct.std::_Tuple_impl.59"*, align 8
  store %"struct.std::_Tuple_impl.59"* %__t, %"struct.std::_Tuple_impl.59"** %__t.addr, align 8
  %0 = load %"struct.std::_Tuple_impl.59"*, %"struct.std::_Tuple_impl.59"** %__t.addr, align 8
  %1 = bitcast %"struct.std::_Tuple_impl.59"* %0 to %"struct.std::_Head_base.62"*
  %call = call nonnull align 8 dereferenceable(8) %"class.tensorflow::TensorInterface"** @_ZNSt10_Head_baseILm0EPN10tensorflow7Variant5ValueINS0_6TensorEEELb0EE7_M_headERS6_(%"struct.std::_Head_base.62"* nonnull align 8 dereferenceable(8) %1) #11
  ret %"class.tensorflow::TensorInterface"** %call
}

; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local nonnull align 8 dereferenceable(8) %"class.tensorflow::TensorInterface"** @_ZNSt10_Head_baseILm0EPN10tensorflow7Variant5ValueINS0_6TensorEEELb0EE7_M_headERS6_(%"struct.std::_Head_base.62"* nonnull align 8 dereferenceable(8) %__b) #0 comdat align 2 {
entry:
  %__b.addr = alloca %"struct.std::_Head_base.62"*, align 8
  store %"struct.std::_Head_base.62"* %__b, %"struct.std::_Head_base.62"** %__b.addr, align 8
  %0 = load %"struct.std::_Head_base.62"*, %"struct.std::_Head_base.62"** %__b.addr, align 8
  %_M_head_impl = getelementptr inbounds %"struct.std::_Head_base.62", %"struct.std::_Head_base.62"* %0, i32 0, i32 0
  ret %"class.tensorflow::TensorInterface"** %_M_head_impl
}

; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local %"class.tensorflow::TensorInterface"* @_ZNSt10unique_ptrIN10tensorflow7Variant5ValueINS0_6TensorEEESt14default_deleteIS4_EE7releaseEv(%"class.std::unique_ptr.55"* %this) #0 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::unique_ptr.55"*, align 8
  store %"class.std::unique_ptr.55"* %this, %"class.std::unique_ptr.55"** %this.addr, align 8
  %this1 = load %"class.std::unique_ptr.55"*, %"class.std::unique_ptr.55"** %this.addr, align 8
  %_M_t = getelementptr inbounds %"class.std::unique_ptr.55", %"class.std::unique_ptr.55"* %this1, i32 0, i32 0
  %0 = bitcast %"struct.std::__uniq_ptr_data.56"* %_M_t to %"class.std::__uniq_ptr_impl.57"*
  %call = call %"class.tensorflow::TensorInterface"* @_ZNSt15__uniq_ptr_implIN10tensorflow7Variant5ValueINS0_6TensorEEESt14default_deleteIS4_EE7releaseEv(%"class.std::__uniq_ptr_impl.57"* %0) #11
  ret %"class.tensorflow::TensorInterface"* %call
}
...
entry:
  ...
  %this2 = load %"struct.std::__uniq_ptr_data.24"*, %"struct.std::__uniq_ptr_data.24"** %this.addr, align 8
  %2 = bitcast %"struct.std::__uniq_ptr_data.24"* %this2 to %"class.std::__uniq_ptr_impl.25"*
  ...
  call void @_ZNSt15__uniq_ptr_implIN10tensorflow7Variant14ValueInterfaceESt14default_deleteIS2_EEC2IS3_INS1_5ValueINS0_6TensorEEEEEEPS2_OT_(%"class.std::__uniq_ptr_impl.25"* %2, %"class.tensorflow::AbstractTensorInterface"* %3, %"class.std::ios_base::Init"* nonnull align 1 dereferenceable(1) %4)
  ret void
}

; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSt15__uniq_ptr_implIN10tensorflow7Variant14ValueInterfaceESt14default_deleteIS2_EEC2IS3_INS1_5ValueINS0_6TensorEEEEEEPS2_OT_(%"class.std::__uniq_ptr_impl.25"* %this, %"class.tensorflow::AbstractTensorInterface"* %__p, %"class.std::ios_base::Init"* nonnull align 1 dereferenceable(1) %__d) unnamed_addr #0 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::__uniq_ptr_impl.25"*, align 8
...
entry:
  ...
  %2 = bitcast %"struct.std::_Tuple_impl.27"* %this1 to %struct.TF_Tensor*
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local %"class.tensorflow::TensorInterface"* @_ZNSt15__uniq_ptr_implIN10tensorflow7Variant5ValueINS0_6TensorEEESt14default_deleteIS4_EE7releaseEv(%"class.std::__uniq_ptr_impl.57"* %this) #0 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
  %this.addr = alloca %"class.std::__uniq_ptr_impl.57"*, align 8
  %__p = alloca %"class.tensorflow::TensorInterface"*, align 8
  store %"class.std::__uniq_ptr_impl.57"* %this, %"class.std::__uniq_ptr_impl.57"** %this.addr, align 8
  %this1 = load %"class.std::__uniq_ptr_impl.57"*, %"class.std::__uniq_ptr_impl.57"** %this.addr, align 8
  %call = invoke nonnull align 8 dereferenceable(8) %"class.tensorflow::TensorInterface"** @_ZNSt15__uniq_ptr_implIN10tensorflow7Variant5ValueINS0_6TensorEEESt14default_deleteIS4_EE6_M_ptrEv(%"class.std::__uniq_ptr_impl.57"* %this1)
          to label %invoke.cont unwind label %terminate.lpad
...
invoke.cont:                                      ; preds = %entry
  ...
  %call3 = invoke nonnull align 8 dereferenceable(8) %"class.tensorflow::TensorInterface"** @_ZNSt15__uniq_ptr_implIN10tensorflow7Variant5ValueINS0_6TensorEEESt14default_deleteIS4_EE6_M_ptrEv(%"class.std::__uniq_ptr_impl.57"* %this1)
          to label %invoke.cont2 unwind label %terminate.lpad
...
declare dso_local nonnull i8* @_ZN4absl12lts_2025012712log_internal17MakeCheckOpStringIPKvS4_EEPKcT_T0_S6_(i8*, i8*, i8*) #4
...
while.cond:                                       ; preds = %entry
  %call = call i32 @_ZNK10tensorflow6Tensor5dtypeEv(%"class.tensorflow::Tensor"* %this1)
  store i32 %call, i32* %ref.tmp, align 4
  %call2 = call nonnull align 4 dereferenceable(4) i32* @_ZN4absl12lts_2025012712log_internal21GetReferenceableValueIN10tensorflow8DataTypeEEERKT_S7_(i32* nonnull align 4 dereferenceable(4) %ref.tmp)
  %call3 = call nonnull align 4 dereferenceable(4) i32* @_ZN4absl12lts_2025012712log_internal21GetReferenceableValueIN10tensorflow8DataTypeEEERKT_S7_(i32* nonnull align 4 dereferenceable(4) %expected_dtype.addr)
  %call4 = call i8* @_ZN4absl12lts_2025012712log_internal12Check_EQImplIN10tensorflow8DataTypeES4_EEPKcRKT_RKT0_S6_(i32* nonnull align 4 dereferenceable(4) %call2, i32* nonnull align 4 dereferenceable(4) %call3, i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.4.18, i64 0, i64 0))
  store i8* %call4, i8** %absl_log_internal_check_op_result, align 8
  %0 = load i8*, i8** %absl_log_internal_check_op_result, align 8
  %tobool = icmp ne i8* %0, null
  br i1 %tobool, label %while.body, label %while.end
...
while.body:                                       ; preds = %while.cond
  %1 = load i8*, i8** %absl_log_internal_check_op_result, align 8
  %call7 = call i8* @_ZN4absl12lts_2025012713implicit_castIPKcEET_NS0_8internal13type_identityIS4_E4typeE(i8* %1)
  call void @_ZN4absl12lts_2025012712log_internal15LogMessageFatalC1EPKciS4_(%"class.absl::lts_20250127::log_internal::LogMessageFatal"* %ref.tmp6, i8* getelementptr inbounds ([78 x i8], [78 x i8]* @.str.5.19, i64 0, i64 0), i32 861, i8* %call7) #22
  %2 = bitcast %"class.absl::lts_20250127::log_internal::LogMessageFatal"* %ref.tmp6 to %"class.absl::lts_20250127::log_internal::LogMessage"*
  %call8 = invoke nonnull align 8 dereferenceable(16) %"class.absl::lts_20250127::log_internal::LogMessage"* @_ZN4absl12lts_2025012712log_internal10LogMessage14InternalStreamEv(%"class.absl::lts_20250127::log_internal::LogMessage"* %2)
          to label %invoke.cont unwind label %lpad

invoke.cont:                                      ; preds = %while.body
  %call10 = invoke nonnull align 8 dereferenceable(16) %"class.absl::lts_20250127::log_internal::LogMessage"* @_ZN4absl12lts_2025012712log_internal10LogMessagelsILi2EEERS2_RAT__Kc(%"class.absl::lts_20250127::log_internal::LogMessage"* %call8, [2 x i8]* nonnull align 1 dereferenceable(2) @.str.6.20)
          to label %invoke.cont9 unwind label %lpad

invoke.cont9:                                     ; preds = %invoke.cont
  %3 = load i32, i32* %expected_dtype.addr, align 4
  invoke void @_ZN10tensorflow14DataTypeStringB5cxx11ENS_8DataTypeE(%"class.std::__cxx11::basic_string"* sret align 8 %ref.tmp11, i32 %3)
          to label %invoke.cont12 unwind label %lpad

invoke.cont12:                                    ; preds = %invoke.cont9
  %call15 = invoke nonnull align 8 dereferenceable(16) %"class.absl::lts_20250127::log_internal::LogMessage"* @_ZN4absl12lts_2025012712log_internal10LogMessagelsERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE(%"class.absl::lts_20250127::log_internal::LogMessage"* %call10, %"class.std::__cxx11::basic_string"* nonnull align 8 dereferenceable(32) %ref.tmp11)
          to label %invoke.cont14 unwind label %lpad13

invoke.cont14:                                    ; preds = %invoke.cont12
  %call17 = invoke nonnull align 8 dereferenceable(16) %"class.absl::lts_20250127::log_internal::LogMessage"* @_ZN4absl12lts_2025012712log_internal10LogMessagelsILi16EEERS2_RAT__Kc(%"class.absl::lts_20250127::log_internal::LogMessage"* %call15, [16 x i8]* nonnull align 1 dereferenceable(16) @.str.7.21)
          to label %invoke.cont16 unwind label %lpad13

invoke.cont16:                                    ; preds = %invoke.cont14
  %call20 = invoke i32 @_ZNK10tensorflow6Tensor5dtypeEv(%"class.tensorflow::Tensor"* %this1)
          to label %invoke.cont19 unwind label %lpad13

invoke.cont19:                                    ; preds = %invoke.cont16
  invoke void @_ZN10tensorflow14DataTypeStringB5cxx11ENS_8DataTypeE(%"class.std::__cxx11::basic_string"* sret align 8 %ref.tmp18, i32 %call20)
          to label %invoke.cont21 unwind label %lpad13

invoke.cont21:                                    ; preds = %invoke.cont19
  %call24 = invoke nonnull align 8 dereferenceable(16) %"class.absl::lts_20250127::log_internal::LogMessage"* @_ZN4absl12lts_2025012712log_internal10LogMessagelsERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE(%"class.absl::lts_20250127::log_internal::LogMessage"* %call17, %"class.std::__cxx11::basic_string"* nonnull align 8 dereferenceable(32) %ref.tmp18)
          to label %invoke.cont23 unwind label %lpad22

invoke.cont23:                                    ; preds = %invoke.cont21
  invoke void @_ZNKO4absl12lts_2025012712log_internal7VoidifyaaINS1_10LogMessageEEEvRKT_(%"class.std::ios_base::Init"* %ref.tmp5, %"class.absl::lts_20250127::log_internal::LogMessage"* nonnull align 8 dereferenceable(16) %call24)
          to label %invoke.cont25 unwind label %lpad22

invoke.cont25:                                    ; preds = %invoke.cont23
  call void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED1Ev(%"class.std::__cxx11::basic_string"* %ref.tmp18) #11
  call void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED1Ev(%"class.std::__cxx11::basic_string"* %ref.tmp11) #11
  call void @_ZN4absl12lts_2025012712log_internal15LogMessageFatalD1Ev(%"class.absl::lts_20250127::log_internal::LogMessageFatal"* %ref.tmp6) #16
  unreachable

lpad:                                             ; preds = %invoke.cont9, %invoke.cont, %while.body
  %4 = landingpad { i8*, i32 }
          cleanup
  %5 = extractvalue { i8*, i32 } %4, 0
  store i8* %5, i8** %exn.slot, align 8
...
lpad13:                                           ; preds = %invoke.cont19, %invoke.cont16, %invoke.cont14, %invoke.cont12
  %7 = landingpad { i8*, i32 }
          cleanup
  %8 = extractvalue { i8*, i32 } %7, 0
  store i8* %8, i8** %exn.slot, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local nonnull align 4 dereferenceable(4) i32* @_ZN4absl12lts_2025012712log_internal21GetReferenceableValueIN10tensorflow8DataTypeEEERKT_S7_(i32* nonnull align 4 dereferenceable(4) %t) #0 comdat {
entry:
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local i8* @_ZN4absl12lts_2025012712log_internal12Check_EQImplIN10tensorflow8DataTypeES4_EEPKcRKT_RKT0_S6_(i32* nonnull align 4 dereferenceable(4) %v1, i32* nonnull align 4 dereferenceable(4) %v2, i8* %exprtext) #6 comdat {
entry:
  %v1.addr = alloca i32*, align 8
  %v2.addr = alloca i32*, align 8
  %exprtext.addr = alloca i8*, align 8
...
cond.false:                                       ; preds = %entry
  ...
  %conv = sext i32 %5 to i64
  %6 = load i32*, i32** %v2.addr, align 8
  %7 = load i32, i32* %6, align 4
  %conv1 = sext i32 %7 to i64
  %8 = load i8*, i8** %exprtext.addr, align 8
  %call = call nonnull i8* @_ZN4absl12lts_2025012712log_internal17MakeCheckOpStringIllEEPKcT_T0_S4_(i64 %conv, i64 %conv1, i8* %8)
  br label %cond.end
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local nonnull align 8 dereferenceable(16) %"class.absl::lts_20250127::log_internal::LogMessage"* @_ZN4absl12lts_2025012712log_internal10LogMessagelsILi2EEERS2_RAT__Kc(%"class.absl::lts_20250127::log_internal::LogMessage"* %this, [2 x i8]* nonnull align 1 dereferenceable(2) %buf) #6 comdat align 2 {
entry:
  %this.addr = alloca %"class.absl::lts_20250127::log_internal::LogMessage"*, align 8
  %buf.addr = alloca [2 x i8]*, align 8
  %agg.tmp = alloca %"class.std::basic_string_view", align 8
  store %"class.absl::lts_20250127::log_internal::LogMessage"* %this, %"class.absl::lts_20250127::log_internal::LogMessage"** %this.addr, align 8
  store [2 x i8]* %buf, [2 x i8]** %buf.addr, align 8
  %this1 = load %"class.absl::lts_20250127::log_internal::LogMessage"*, %"class.absl::lts_20250127::log_internal::LogMessage"** %this.addr, align 8
  %0 = load [2 x i8]*, [2 x i8]** %buf.addr, align 8
  %arraydecay = getelementptr inbounds [2 x i8], [2 x i8]* %0, i64 0, i64 0
  call void @_ZNSt17basic_string_viewIcSt11char_traitsIcEEC2EPKc(%"class.std::basic_string_view"* %agg.tmp, i8* %arraydecay) #11
  %1 = bitcast %"class.std::basic_string_view"* %agg.tmp to { i64, i8* }*
  %2 = getelementptr inbounds { i64, i8* }, { i64, i8* }* %1, i32 0, i32 0
  %3 = load i64, i64* %2, align 8
...
declare dso_local nonnull align 8 dereferenceable(16) %"class.absl::lts_20250127::log_internal::LogMessage"* @_ZN4absl12lts_2025012712log_internal10LogMessagelsERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE(%"class.absl::lts_20250127::log_internal::LogMessage"*, %"class.std::__cxx11::basic_string"* nonnull align 8 dereferenceable(32)) #4

; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local nonnull align 8 dereferenceable(16) %"class.absl::lts_20250127::log_internal::LogMessage"* @_ZN4absl12lts_2025012712log_internal10LogMessagelsILi16EEERS2_RAT__Kc(%"class.absl::lts_20250127::log_internal::LogMessage"* %this, [16 x i8]* nonnull align 1 dereferenceable(16) %buf) #6 comdat align 2 {
entry:
  %this.addr = alloca %"class.absl::lts_20250127::log_internal::LogMessage"*, align 8
  ...
  %this1 = load %"class.absl::lts_20250127::log_internal::LogMessage"*, %"class.absl::lts_20250127::log_internal::LogMessage"** %this.addr, align 8
  %0 = load [16 x i8]*, [16 x i8]** %buf.addr, align 8
  %arraydecay = getelementptr inbounds [16 x i8], [16 x i8]* %0, i64 0, i64 0
  call void @_ZNSt17basic_string_viewIcSt11char_traitsIcEEC2EPKc(%"class.std::basic_string_view"* %agg.tmp, i8* %arraydecay) #11
  %1 = bitcast %"class.std::basic_string_view"* %agg.tmp to { i64, i8* }*
  %2 = getelementptr inbounds { i64, i8* }, { i64, i8* }* %1, i32 0, i32 0
  %3 = load i64, i64* %2, align 8
...
declare dso_local nonnull i8* @_ZN4absl12lts_2025012712log_internal17MakeCheckOpStringIllEEPKcT_T0_S4_(i64, i64, i8*) #4
...
entry:
  ...
  %ref.tmp11 = alloca %"class.std::__cxx11::basic_string", align 8
  %ref.tmp18 = alloca %"class.std::__cxx11::basic_string", align 8
  %ref.tmp28 = alloca %"class.std::ios_base::Init", align 1
  %ref.tmp29 = alloca %"class.absl::lts_20250127::log_internal::LogMessageFatal", align 8
  %cleanup.cond = alloca i1, align 1
  store %"class.tensorflow::Tensor"* %this, %"class.tensorflow::Tensor"** %this.addr, align 8
  store i32 %expected_dtype, i32* %expected_dtype.addr, align 4
  %this1 = load %"class.tensorflow::Tensor"*, %"class.tensorflow::Tensor"** %this.addr, align 8
...
while.body:                                       ; preds = %while.cond
  %1 = load i8*, i8** %absl_log_internal_check_op_result, align 8
  %call7 = call i8* @_ZN4absl12lts_2025012713implicit_castIPKcEET_NS0_8internal13type_identityIS4_E4typeE(i8* %1)
  call void @_ZN4absl12lts_2025012712log_internal15LogMessageFatalC1EPKciS4_(%"class.absl::lts_20250127::log_internal::LogMessageFatal"* %ref.tmp6, i8* getelementptr inbounds ([78 x i8], [78 x i8]* @.str.5.19, i64 0, i64 0), i32 867, i8* %call7) #22
  %2 = bitcast %"class.absl::lts_20250127::log_internal::LogMessageFatal"* %ref.tmp6 to %"class.absl::lts_20250127::log_internal::LogMessage"*
  %call8 = invoke nonnull align 8 dereferenceable(16) %"class.absl::lts_20250127::log_internal::LogMessage"* @_ZN4absl12lts_2025012712log_internal10LogMessage14InternalStreamEv(%"class.absl::lts_20250127::log_internal::LogMessage"* %2)
          to label %invoke.cont unwind label %lpad
...
while.end:                                        ; preds = %while.cond
  %call27 = call zeroext i1 @_ZNK10tensorflow6Tensor9IsAlignedEv(%"class.tensorflow::Tensor"* %this1)
...
cond.false:                                       ; preds = %while.end
  call void @_ZN4absl12lts_2025012712log_internal15LogMessageFatalC1EPKciS4_(%"class.absl::lts_20250127::log_internal::LogMessageFatal"* %ref.tmp29, i8* getelementptr inbounds ([78 x i8], [78 x i8]* @.str.5.19, i64 0, i64 0), i32 870, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.8.22, i64 0, i64 0)) #22
  store i1 true, i1* %cleanup.cond, align 1
  %14 = bitcast %"class.absl::lts_20250127::log_internal::LogMessageFatal"* %ref.tmp29 to %"class.absl::lts_20250127::log_internal::LogMessage"*
  %call32 = invoke nonnull align 8 dereferenceable(16) %"class.absl::lts_20250127::log_internal::LogMessage"* @_ZN4absl12lts_2025012712log_internal10LogMessage14InternalStreamEv(%"class.absl::lts_20250127::log_internal::LogMessage"* %14)
          to label %invoke.cont31 unwind label %lpad30

invoke.cont31:                                    ; preds = %cond.false
  %call34 = invoke nonnull align 8 dereferenceable(16) %"class.absl::lts_20250127::log_internal::LogMessage"* @_ZN4absl12lts_2025012712log_internal10LogMessagelsILi7EEERS2_RAT__Kc(%"class.absl::lts_20250127::log_internal::LogMessage"* %call32, [7 x i8]* nonnull align 1 dereferenceable(7) @.str.9.23)
          to label %invoke.cont33 unwind label %lpad30

invoke.cont33:                                    ; preds = %invoke.cont31
  %call36 = invoke i8* @_ZNK10tensorflow6Tensor4baseIvEEPT_v(%"class.tensorflow::Tensor"* %this1)
          to label %invoke.cont35 unwind label %lpad30

invoke.cont35:                                    ; preds = %invoke.cont33
  %call38 = invoke nonnull align 8 dereferenceable(16) %"class.absl::lts_20250127::log_internal::LogMessage"* @_ZN4absl12lts_2025012712log_internal10LogMessagelsEPv(%"class.absl::lts_20250127::log_internal::LogMessage"* %call34, i8* %call36)
          to label %invoke.cont37 unwind label %lpad30

invoke.cont37:                                    ; preds = %invoke.cont35
  invoke void @_ZNKO4absl12lts_2025012712log_internal7VoidifyaaINS1_10LogMessageEEEvRKT_(%"class.std::ios_base::Init"* %ref.tmp28, %"class.absl::lts_20250127::log_internal::LogMessage"* nonnull align 8 dereferenceable(16) %call38)
...
cleanup.action:                                   ; preds = %cond.end
  call void @_ZN4absl12lts_2025012712log_internal15LogMessageFatalD1Ev(%"class.absl::lts_20250127::log_internal::LogMessageFatal"* %ref.tmp29) #16
  unreachable

lpad30:                                           ; preds = %invoke.cont37, %invoke.cont35, %invoke.cont33, %invoke.cont31, %cond.false
  %15 = landingpad { i8*, i32 }
          cleanup
  %16 = extractvalue { i8*, i32 } %15, 0
  ...
  %cleanup.is_active41 = load i1, i1* %cleanup.cond, align 1
  br i1 %cleanup.is_active41, label %cleanup.action42, label %cleanup.done43

18:                                               ; No predecessors!
  br label %cleanup.done

cleanup.done:                                     ; preds = %18, %cond.end
  ret void

cleanup.action42:                                 ; preds = %lpad30
  call void @_ZN4absl12lts_2025012712log_internal15LogMessageFatalD1Ev(%"class.absl::lts_20250127::log_internal::LogMessageFatal"* %ref.tmp29) #16
  unreachable
...
cleanup.done43:                                   ; preds = %19, %lpad30
  br label %eh.resume

eh.resume:                                        ; preds = %cleanup.done43, %13
  %exn = load i8*, i8** %exn.slot, align 8
  %sel = load i32, i32* %ehselector.slot, align 4
  %lpad.val = insertvalue { i8*, i32 } undef, i8* %exn, 0
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local nonnull align 8 dereferenceable(16) %"class.absl::lts_20250127::log_internal::LogMessage"* @_ZN4absl12lts_2025012712log_internal10LogMessagelsILi7EEERS2_RAT__Kc(%"class.absl::lts_20250127::log_internal::LogMessage"* %this, [7 x i8]* nonnull align 1 dereferenceable(7) %buf) #6 comdat align 2 {
entry:
  %this.addr = alloca %"class.absl::lts_20250127::log_internal::LogMessage"*, align 8
  %buf.addr = alloca [7 x i8]*, align 8
  %agg.tmp = alloca %"class.std::basic_string_view", align 8
  store %"class.absl::lts_20250127::log_internal::LogMessage"* %this, %"class.absl::lts_20250127::log_internal::LogMessage"** %this.addr, align 8
  store [7 x i8]* %buf, [7 x i8]** %buf.addr, align 8
  %this1 = load %"class.absl::lts_20250127::log_internal::LogMessage"*, %"class.absl::lts_20250127::log_internal::LogMessage"** %this.addr, align 8
  %0 = load [7 x i8]*, [7 x i8]** %buf.addr, align 8
  %arraydecay = getelementptr inbounds [7 x i8], [7 x i8]* %0, i64 0, i64 0
  call void @_ZNSt17basic_string_viewIcSt11char_traitsIcEEC2EPKc(%"class.std::basic_string_view"* %agg.tmp, i8* %arraydecay) #11
  %1 = bitcast %"class.std::basic_string_view"* %agg.tmp to { i64, i8* }*
  %2 = getelementptr inbounds { i64, i8* }, { i64, i8* }* %1, i32 0, i32 0
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local nonnull align 8 dereferenceable(16) %"class.absl::lts_20250127::log_internal::LogMessage"* @_ZN4absl12lts_2025012712log_internal10LogMessagelsEPv(%"class.absl::lts_20250127::log_internal::LogMessage"* %this, i8* %v) #6 comdat align 2 {
entry:
  %this.addr = alloca %"class.absl::lts_20250127::log_internal::LogMessage"*, align 8
  %v.addr = alloca i8*, align 8
  store %"class.absl::lts_20250127::log_internal::LogMessage"* %this, %"class.absl::lts_20250127::log_internal::LogMessage"** %this.addr, align 8
  store i8* %v, i8** %v.addr, align 8
  %this1 = load %"class.absl::lts_20250127::log_internal::LogMessage"*, %"class.absl::lts_20250127::log_internal::LogMessage"** %this.addr, align 8
  %call = call nonnull align 8 dereferenceable(16) %"class.absl::lts_20250127::log_internal::LogMessage"* @_ZN4absl12lts_2025012712log_internal10LogMessagelsIPvLi0EEERS2_RKT_(%"class.absl::lts_20250127::log_internal::LogMessage"* %this1, i8** nonnull align 8 dereferenceable(8) %v.addr)
  ret %"class.absl::lts_20250127::log_internal::LogMessage"* %call
}

declare dso_local nonnull align 8 dereferenceable(16) %"class.absl::lts_20250127::log_internal::LogMessage"* @_ZN4absl12lts_2025012712log_internal10LogMessagelsIPvLi0EEERS2_RKT_(%"class.absl::lts_20250127::log_internal::LogMessage"*, i8** nonnull align 8 dereferenceable(8)) #4
...
entry:
  %this.addr = alloca %"class.tensorflow::Tensor"*, align 8
  %ref.tmp = alloca %"class.std::ios_base::Init", align 1
  %ref.tmp2 = alloca %"class.absl::lts_20250127::log_internal::LogMessageFatal", align 8
  %cleanup.cond = alloca i1, align 1
  %exn.slot = alloca i8*, align 8
  %ehselector.slot = alloca i32, align 4
  %absl_log_internal_check_op_result = alloca i8*, align 8
  ...
  %ref.tmp16 = alloca %"class.std::ios_base::Init", align 1
  %ref.tmp17 = alloca %"class.absl::lts_20250127::log_internal::LogMessageFatal", align 8
  store %"class.tensorflow::Tensor"* %this, %"class.tensorflow::Tensor"** %this.addr, align 8
  %this1 = load %"class.tensorflow::Tensor"*, %"class.tensorflow::Tensor"** %this.addr, align 8
...
cond.false:                                       ; preds = %entry
  call void @_ZN4absl12lts_2025012712log_internal15LogMessageFatalC1EPKciS4_(%"class.absl::lts_20250127::log_internal::LogMessageFatal"* %ref.tmp2, i8* getelementptr inbounds ([78 x i8], [78 x i8]* @.str.5.19, i64 0, i64 0), i32 874, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.8.22, i64 0, i64 0)) #22
  store i1 true, i1* %cleanup.cond, align 1
  %0 = bitcast %"class.absl::lts_20250127::log_internal::LogMessageFatal"* %ref.tmp2 to %"class.absl::lts_20250127::log_internal::LogMessage"*
  %call3 = invoke nonnull align 8 dereferenceable(16) %"class.absl::lts_20250127::log_internal::LogMessage"* @_ZN4absl12lts_2025012712log_internal10LogMessage14InternalStreamEv(%"class.absl::lts_20250127::log_internal::LogMessage"* %0)
          to label %invoke.cont unwind label %lpad

invoke.cont:                                      ; preds = %cond.false
  %call5 = invoke nonnull align 8 dereferenceable(16) %"class.absl::lts_20250127::log_internal::LogMessage"* @_ZN4absl12lts_2025012712log_internal10LogMessagelsILi27EEERS2_RAT__Kc(%"class.absl::lts_20250127::log_internal::LogMessage"* %call3, [27 x i8]* nonnull align 1 dereferenceable(27) @.str.10.24)
          to label %invoke.cont4 unwind label %lpad

invoke.cont4:                                     ; preds = %invoke.cont
  invoke void @_ZNKO4absl12lts_2025012712log_internal7VoidifyaaINS1_10LogMessageEEEvRKT_(%"class.std::ios_base::Init"* %ref.tmp, %"class.absl::lts_20250127::log_internal::LogMessage"* nonnull align 8 dereferenceable(16) %call5)
          to label %invoke.cont6 unwind label %lpad
...
cleanup.action:                                   ; preds = %cond.end
  call void @_ZN4absl12lts_2025012712log_internal15LogMessageFatalD1Ev(%"class.absl::lts_20250127::log_internal::LogMessageFatal"* %ref.tmp2) #16
  unreachable
...
while.cond:                                       ; preds = %cleanup.done
  %call11 = call i32 @_ZN4absl12lts_2025012712log_internal21GetReferenceableValueEi(i32 1)
  store i32 %call11, i32* %ref.tmp10, align 4
  %call13 = call i64 @_ZNK10tensorflow6Tensor11NumElementsEv(%"class.tensorflow::Tensor"* %this1)
  %call14 = call i64 @_ZN4absl12lts_2025012712log_internal21GetReferenceableValueEl(i64 %call13)
  store i64 %call14, i64* %ref.tmp12, align 8
  %call15 = call i8* @_ZN4absl12lts_2025012712log_internal12Check_EQImplIilEEPKcRKT_RKT0_S4_(i32* nonnull align 4 dereferenceable(4) %ref.tmp10, i64* nonnull align 8 dereferenceable(8) %ref.tmp12, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.11.25, i64 0, i64 0))
  store i8* %call15, i8** %absl_log_internal_check_op_result, align 8
  %5 = load i8*, i8** %absl_log_internal_check_op_result, align 8
  %tobool = icmp ne i8* %5, null
  br i1 %tobool, label %while.body, label %while.end

while.body:                                       ; preds = %while.cond
  %6 = load i8*, i8** %absl_log_internal_check_op_result, align 8
  %call18 = call i8* @_ZN4absl12lts_2025012713implicit_castIPKcEET_NS0_8internal13type_identityIS4_E4typeE(i8* %6)
  call void @_ZN4absl12lts_2025012712log_internal15LogMessageFatalC1EPKciS4_(%"class.absl::lts_20250127::log_internal::LogMessageFatal"* %ref.tmp17, i8* getelementptr inbounds ([78 x i8], [78 x i8]* @.str.5.19, i64 0, i64 0), i32 875, i8* %call18) #22
  %7 = bitcast %"class.absl::lts_20250127::log_internal::LogMessageFatal"* %ref.tmp17 to %"class.absl::lts_20250127::log_internal::LogMessage"*
  %call21 = invoke nonnull align 8 dereferenceable(16) %"class.absl::lts_20250127::log_internal::LogMessage"* @_ZN4absl12lts_2025012712log_internal10LogMessage14InternalStreamEv(%"class.absl::lts_20250127::log_internal::LogMessage"* %7)
          to label %invoke.cont20 unwind label %lpad19

invoke.cont20:                                    ; preds = %while.body
  %call23 = invoke nonnull align 8 dereferenceable(16) %"class.absl::lts_20250127::log_internal::LogMessage"* @_ZN4absl12lts_2025012712log_internal10LogMessagelsILi31EEERS2_RAT__Kc(%"class.absl::lts_20250127::log_internal::LogMessage"* %call21, [31 x i8]* nonnull align 1 dereferenceable(31) @.str.12.26)
          to label %invoke.cont22 unwind label %lpad19

invoke.cont22:                                    ; preds = %invoke.cont20
  invoke void @_ZNKO4absl12lts_2025012712log_internal7VoidifyaaINS1_10LogMessageEEEvRKT_(%"class.std::ios_base::Init"* %ref.tmp16, %"class.absl::lts_20250127::log_internal::LogMessage"* nonnull align 8 dereferenceable(16) %call23)
          to label %invoke.cont24 unwind label %lpad19

invoke.cont24:                                    ; preds = %invoke.cont22
  call void @_ZN4absl12lts_2025012712log_internal15LogMessageFatalD1Ev(%"class.absl::lts_20250127::log_internal::LogMessageFatal"* %ref.tmp17) #16
  unreachable
...
lpad19:                                           ; preds = %invoke.cont22, %invoke.cont20, %while.body
  %9 = landingpad { i8*, i32 }
          cleanup
  %10 = extractvalue { i8*, i32 } %9, 0
  store i8* %10, i8** %exn.slot, align 8
...
eh.resume:                                        ; preds = %12, %cleanup.done9
  %exn = load i8*, i8** %exn.slot, align 8
  %sel = load i32, i32* %ehselector.slot, align 4
  %lpad.val = insertvalue { i8*, i32 } undef, i8* %exn, 0
  %lpad.val25 = insertvalue { i8*, i32 } %lpad.val, i32 %sel, 1
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local nonnull align 8 dereferenceable(16) %"class.absl::lts_20250127::log_internal::LogMessage"* @_ZN4absl12lts_2025012712log_internal10LogMessagelsILi27EEERS2_RAT__Kc(%"class.absl::lts_20250127::log_internal::LogMessage"* %this, [27 x i8]* nonnull align 1 dereferenceable(27) %buf) #6 comdat align 2 {
entry:
  %this.addr = alloca %"class.absl::lts_20250127::log_internal::LogMessage"*, align 8
  %buf.addr = alloca [27 x i8]*, align 8
  %agg.tmp = alloca %"class.std::basic_string_view", align 8
  store %"class.absl::lts_20250127::log_internal::LogMessage"* %this, %"class.absl::lts_20250127::log_internal::LogMessage"** %this.addr, align 8
  store [27 x i8]* %buf, [27 x i8]** %buf.addr, align 8
  %this1 = load %"class.absl::lts_20250127::log_internal::LogMessage"*, %"class.absl::lts_20250127::log_internal::LogMessage"** %this.addr, align 8
  %0 = load [27 x i8]*, [27 x i8]** %buf.addr, align 8
  %arraydecay = getelementptr inbounds [27 x i8], [27 x i8]* %0, i64 0, i64 0
  call void @_ZNSt17basic_string_viewIcSt11char_traitsIcEEC2EPKc(%"class.std::basic_string_view"* %agg.tmp, i8* %arraydecay) #11
  %1 = bitcast %"class.std::basic_string_view"* %agg.tmp to { i64, i8* }*
  %2 = getelementptr inbounds { i64, i8* }, { i64, i8* }* %1, i32 0, i32 0
  %3 = load i64, i64* %2, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local i32 @_ZN4absl12lts_2025012712log_internal21GetReferenceableValueEi(i32 %t) #0 comdat {
entry:
  %t.addr = alloca i32, align 4
  store i32 %t, i32* %t.addr, align 4
  %0 = load i32, i32* %t.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local i64 @_ZN4absl12lts_2025012712log_internal21GetReferenceableValueEl(i64 %t) #0 comdat {
entry:
  %t.addr = alloca i64, align 8
  store i64 %t, i64* %t.addr, align 8
  %0 = load i64, i64* %t.addr, align 8
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local i8* @_ZN4absl12lts_2025012712log_internal12Check_EQImplIilEEPKcRKT_RKT0_S4_(i32* nonnull align 4 dereferenceable(4) %v1, i64* nonnull align 8 dereferenceable(8) %v2, i8* %exprtext) #6 comdat {
entry:
  %v1.addr = alloca i32*, align 8
  %v2.addr = alloca i64*, align 8
  %exprtext.addr = alloca i8*, align 8
...
cond.false:                                       ; preds = %entry
  ...
  %7 = load i64, i64* %6, align 8
  %8 = load i8*, i8** %exprtext.addr, align 8
  %call = call nonnull i8* @_ZN4absl12lts_2025012712log_internal17MakeCheckOpStringIllEEPKcT_T0_S4_(i64 %conv2, i64 %7, i8* %8)
  br label %cond.end
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local nonnull align 8 dereferenceable(16) %"class.absl::lts_20250127::log_internal::LogMessage"* @_ZN4absl12lts_2025012712log_internal10LogMessagelsILi31EEERS2_RAT__Kc(%"class.absl::lts_20250127::log_internal::LogMessage"* %this, [31 x i8]* nonnull align 1 dereferenceable(31) %buf) #6 comdat align 2 {
entry:
  %this.addr = alloca %"class.absl::lts_20250127::log_internal::LogMessage"*, align 8
  %buf.addr = alloca [31 x i8]*, align 8
  %agg.tmp = alloca %"class.std::basic_string_view", align 8
  store %"class.absl::lts_20250127::log_internal::LogMessage"* %this, %"class.absl::lts_20250127::log_internal::LogMessage"** %this.addr, align 8
  store [31 x i8]* %buf, [31 x i8]** %buf.addr, align 8
  %this1 = load %"class.absl::lts_20250127::log_internal::LogMessage"*, %"class.absl::lts_20250127::log_internal::LogMessage"** %this.addr, align 8
  %0 = load [31 x i8]*, [31 x i8]** %buf.addr, align 8
  %arraydecay = getelementptr inbounds [31 x i8], [31 x i8]* %0, i64 0, i64 0
  call void @_ZNSt17basic_string_viewIcSt11char_traitsIcEEC2EPKc(%"class.std::basic_string_view"* %agg.tmp, i8* %arraydecay) #11
  %1 = bitcast %"class.std::basic_string_view"* %agg.tmp to { i64, i8* }*
  %2 = getelementptr inbounds { i64, i8* }, { i64, i8* }* %1, i32 0, i32 0
  %3 = load i64, i64* %2, align 8

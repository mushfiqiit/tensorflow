...
%"class.absl::lts_20250127::status_internal::StatusRep" = type { %"struct.std::atomic.7", i32, %"class.std::__cxx11::basic_string", %"class.std::unique_ptr" }
%"struct.std::atomic.7" = type { %"class.google::protobuf::internal::CachedSize" }
%"class.std::unique_ptr" = type { %"struct.std::__uniq_ptr_data" }
%"struct.std::__uniq_ptr_data" = type { %"class.std::__uniq_ptr_impl" }
%"class.std::__uniq_ptr_impl" = type { %"class.std::tuple" }
%"class.std::tuple" = type { %"struct.std::_Tuple_impl" }
%"struct.std::_Tuple_impl" = type { %"struct.std::_Head_base.10" }
%"struct.std::_Head_base.10" = type { %"class.absl::lts_20250127::InlinedVector.11"* }
%"class.absl::lts_20250127::InlinedVector.11" = type { %"class.absl::lts_20250127::inlined_vector_internal::Storage.12" }
%"class.absl::lts_20250127::inlined_vector_internal::Storage.12" = type { %"class.absl::lts_20250127::container_internal::CompressedTuple", %"union.absl::lts_20250127::inlined_vector_internal::Storage<absl::lts_20250127::status_internal::Payload, 1, std::allocator<absl::lts_20250127::status_internal::Payload>>::Data" }
...
%"struct.absl::lts_20250127::cord_internal::InlineData::Rep" = type { %union.anon.19 }
%union.anon.19 = type { %"struct.absl::lts_20250127::cord_internal::InlineData::Rep::AsTree" }
...
%"class.absl::lts_20250127::cord_internal::RefcountAndFlags" = type { %"struct.std::atomic.7" }
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNK16TF_ManagedBuffer25FillAllocationDescriptionEPN10tensorflow21AllocationDescriptionE(%class.TF_ManagedBuffer* %this, %"class.tensorflow::AllocationDescription"* %proto) unnamed_addr #0 comdat align 2 {
entry:
  %this.addr = alloca %class.TF_ManagedBuffer*, align 8

...
@.str.6 = private unnamed_addr constant [26 x i8] c"dtype: %d, dims: [%d, %d]\00", align 1
...
if.then35:                                        ; preds = %if.end
  ...
  %call39 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.6, i64 0, i64 0), i32 %33, i64 %34, i64 %35)
...
lor.lhs.false42:                                  ; preds = %if.then35
  ...
  %37 = load i64, i64* %arrayidx43, align 8
...
if.end47:                                         ; preds = %if.end
  ...
  %38 = load i32, i32* %dtype, align 4
  %arrayidx49 = getelementptr inbounds [2 x i64], [2 x i64]* %dims, i64 0, i64 0
  %39 = load i64, i64* %arrayidx49, align 16
  %arrayidx50 = getelementptr inbounds [2 x i64], [2 x i64]* %dims, i64 0, i64 1
  %40 = load i64, i64* %arrayidx50, align 8
  %call51 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.6, i64 0, i64 0), i32 %38, i64 %39, i64 %40)
  %41 = load %struct.TF_Tensor*, %struct.TF_Tensor** %t, align 8
  call void @TF_DeleteTensor(%struct.TF_Tensor* %41)

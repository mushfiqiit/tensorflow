...
declare dso_local void @_ZN10tensorflow6TensorC1EOS0_(%"class.tensorflow::Tensor"*, %"class.tensorflow::Tensor"* nonnull align 8 dereferenceable(40)) unnamed_addr #4
...
entry:
  ...
  store %"class.tensorflow::Tensor"* %this, %"class.tensorflow::Tensor"** %this.addr, align 8
  %this1 = load %"class.tensorflow::Tensor"*, %"class.tensorflow::Tensor"** %this.addr, align 8
  call void @_ZN10tensorflow6TensorC2E8DataType(%"class.tensorflow::Tensor"* %this1, i32 1)
  ret void
}

declare dso_local void @_ZN10tensorflow6TensorC2E8DataType(%"class.tensorflow::Tensor"*, i32) unnamed_addr #4

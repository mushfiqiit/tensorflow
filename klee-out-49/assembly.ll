...
cond.end:                                         ; preds = %cond.false, %cond.true
  %cond = phi i64 [ %28, %cond.true ], [ 16, %cond.false ]
  store i64 %cond, i64* %sym, align 8
  %29 = load i8*, i8** %data, align 8
  %30 = load i64, i64* %sym, align 8
  call void @klee_make_symbolic(i8* %29, i64 %30, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.4, i64 0, i64 0))
  br label %if.end

if.end:                                           ; preds = %cond.end, %land.end27
  %31 = load i32, i32* %dtype, align 4
  ...
  %call36 = call %struct.TF_Tensor* @TF_NewTensor(i32 %31, i64* %arraydecay35, i32 2, i8* %32, i64 %33, void (i8*, i64, i8*)* @_ZL17dummy_deallocatorPvmS_, i8* null)
  store %struct.TF_Tensor* %call36, %struct.TF_Tensor** %t, align 8
  %34 = load %struct.TF_Tensor*, %struct.TF_Tensor** %t, align 8
  %cmp37 = icmp eq %struct.TF_Tensor* %34, null
...
if.end46:                                         ; preds = %if.end
  %37 = load %struct.TF_Tensor*, %struct.TF_Tensor** %t, align 8
  call void @TF_DeleteTensor(%struct.TF_Tensor* %37)

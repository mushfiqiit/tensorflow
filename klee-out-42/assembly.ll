...
land.end34:                                       ; preds = %land.rhs32, %lor.end
  ...
  call void @klee_make_symbolic(i8* %27, i64 8, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.4, i64 0, i64 0))
  ...
  %call41 = call %struct.TF_Tensor* @TF_NewTensor(i32 %28, i64* %arraydecay40, i32 2, i8* %29, i64 %30, void (i8*, i64, i8*)* @_ZL17dummy_deallocatorPvmS_, i8* null)
  store %struct.TF_Tensor* %call41, %struct.TF_Tensor** %t, align 8
  %31 = load %struct.TF_Tensor*, %struct.TF_Tensor** %t, align 8
  %cmp42 = icmp eq %struct.TF_Tensor* %31, null
...
if.then:                                          ; preds = %land.end34
  ...
  %32 = load i64, i64* %arrayidx43, align 16
...
lor.lhs.false45:                                  ; preds = %if.then
  ...
  %33 = load i64, i64* %arrayidx46, align 8
  %cmp47 = icmp eq i64 %33, 0
...
if.end49:                                         ; preds = %land.end34
  %34 = load %struct.TF_Tensor*, %struct.TF_Tensor** %t, align 8
  call void @TF_DeleteTensor(%struct.TF_Tensor* %34)
  %35 = load i8*, i8** %base, align 8

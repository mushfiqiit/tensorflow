...
lor.end:                                          ; preds = %lor.rhs, %lor.lhs.false27, %lor.lhs.false25, %lor.lhs.false23, %lor.lhs.false21, %lor.lhs.false19, %lor.lhs.false, %land.end15
  ...
  %conv32 = zext i1 %cmp31 to i64
  call void @klee_assume(i64 %conv32)
  %call = call noalias i8* @malloc(i64 192) #5
  store i8* %call, i8** %base, align 8
  %22 = load i8*, i8** %base, align 8
  %cmp33 = icmp ne i8* %22, null
  %conv34 = zext i1 %cmp33 to i64
  call void @klee_assume(i64 %conv34)
  %23 = bitcast i32* %offset to i8*
  call void @klee_make_symbolic(i8* %23, i64 4, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.3, i64 0, i64 0))
  %24 = load i32, i32* %offset, align 4
  %cmp35 = icmp ult i32 %24, 32
  %conv36 = zext i1 %cmp35 to i64
  call void @klee_assume(i64 %conv36)
...
cond.end:                                         ; preds = %cond.false, %cond.true
  %cond = phi i64 [ %29, %cond.true ], [ 32, %cond.false ]
  store i64 %cond, i64* %sym, align 8
  %30 = load i8*, i8** %data, align 8
  %31 = load i64, i64* %sym, align 8
  call void @klee_make_symbolic(i8* %30, i64 %31, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.4, i64 0, i64 0))
  br label %if.end

if.end:                                           ; preds = %cond.end, %lor.end
  %32 = load i32, i32* %dtype, align 4
  %arraydecay39 = getelementptr inbounds [3 x i64], [3 x i64]* %dims, i64 0, i64 0
  %33 = load i8*, i8** %data, align 8
  %34 = load i64, i64* %len, align 8
  %call40 = call %struct.TF_Tensor* @TF_NewTensor(i32 %32, i64* %arraydecay39, i32 2, i8* %33, i64 %34, void (i8*, i64, i8*)* @_ZL17dummy_deallocatorPvmS_, i8* null)
  store %struct.TF_Tensor* %call40, %struct.TF_Tensor** %t, align 8
  %35 = load %struct.TF_Tensor*, %struct.TF_Tensor** %t, align 8
  %cmp41 = icmp eq %struct.TF_Tensor* %35, null
  br i1 %cmp41, label %if.then42, label %if.end50

if.then42:                                        ; preds = %if.end
  %arrayidx43 = getelementptr inbounds [3 x i64], [3 x i64]* %dims, i64 0, i64 0
  %36 = load i64, i64* %arrayidx43, align 16
...
if.end50:                                         ; preds = %if.end
  %38 = load %struct.TF_Tensor*, %struct.TF_Tensor** %t, align 8
  call void @TF_DeleteTensor(%struct.TF_Tensor* %38)
  %39 = load i8*, i8** %base, align 8

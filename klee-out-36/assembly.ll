...
@.str.5 = private unnamed_addr constant [9 x i8] c"t Null \0A\00", align 1
@.str.6 = private unnamed_addr constant [38 x i8] c"dtype: %d, dims: [%d, %d], data: [%p]\00", align 1
@.str.7 = private unnamed_addr constant [13 x i8] c"t not Null \0A\00", align 1
...
@.str.8 = private unnamed_addr constant [18 x i8] c"TF_AllocateTensor\00", align 1
...
@.str.5.9 = private unnamed_addr constant [49 x i8] c"cannot create std::vector larger than max_size()\00", align 1
...
@.str.1.12 = private unnamed_addr constant [13 x i8] c"TF_NewTensor\00", align 1
...
if.then35:                                        ; preds = %if.end
  %call36 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.5, i64 0, i64 0))
  %33 = load i32, i32* %dtype, align 4
  %arrayidx37 = getelementptr inbounds [2 x i64], [2 x i64]* %dims, i64 0, i64 0
  %34 = load i64, i64* %arrayidx37, align 16
  %arrayidx38 = getelementptr inbounds [2 x i64], [2 x i64]* %dims, i64 0, i64 1
  %35 = load i64, i64* %arrayidx38, align 8
  %36 = load i8*, i8** %data, align 8
  %call39 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([38 x i8], [38 x i8]* @.str.6, i64 0, i64 0), i32 %33, i64 %34, i64 %35, i8* %36)
  %arrayidx40 = getelementptr inbounds [2 x i64], [2 x i64]* %dims, i64 0, i64 0
  %37 = load i64, i64* %arrayidx40, align 16
  %cmp41 = icmp eq i64 %37, 0
  br i1 %cmp41, label %if.then45, label %lor.lhs.false42

lor.lhs.false42:                                  ; preds = %if.then35
  %arrayidx43 = getelementptr inbounds [2 x i64], [2 x i64]* %dims, i64 0, i64 1
  %38 = load i64, i64* %arrayidx43, align 8
  %cmp44 = icmp eq i64 %38, 0
  br i1 %cmp44, label %if.then45, label %if.else

if.then45:                                        ; preds = %lor.lhs.false42, %if.then35
  br label %if.end46
...
if.end47:                                         ; preds = %if.end
  %call48 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.7, i64 0, i64 0))
  %39 = load i32, i32* %dtype, align 4
  %arrayidx49 = getelementptr inbounds [2 x i64], [2 x i64]* %dims, i64 0, i64 0
  %40 = load i64, i64* %arrayidx49, align 16
  %arrayidx50 = getelementptr inbounds [2 x i64], [2 x i64]* %dims, i64 0, i64 1
  %41 = load i64, i64* %arrayidx50, align 8
  %42 = load i8*, i8** %data, align 8
  %call51 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([38 x i8], [38 x i8]* @.str.6, i64 0, i64 0), i32 %39, i64 %40, i64 %41, i8* %42)
  %43 = load %struct.TF_Tensor*, %struct.TF_Tensor** %t, align 8
  call void @TF_DeleteTensor(%struct.TF_Tensor* %43)
...
entry:
  ...
  %call = call %"class.tensorflow::AbstractTensorInterface"* @_ZN10tensorflow13cpu_allocatorEv()
  %call1 = call i8* @_ZN10tensorflow15allocate_tensorEPKcmPNS_9AllocatorE(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.8, i64 0, i64 0), i64 %0, %"class.tensorflow::AbstractTensorInterface"* %call)
...
if.then:                                          ; preds = %entry
  call void @_ZSt20__throw_length_errorPKc(i8* getelementptr inbounds ([49 x i8], [49 x i8]* @.str.5.9, i64 0, i64 0)) #19
  unreachable
...
if.then:                                          ; preds = %land.end
  ...
  %call7 = invoke i8* @_ZN10tensorflow15allocate_tensorEPKcm(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.1.12, i64 0, i64 0), i64 %8)
          to label %invoke.cont unwind label %lpad

...
land.rhs25:                                       ; preds = %lor.end
  ...
  %cmp26 = icmp uge i64 %19, 0
  br label %land.end27

land.end27:                                       ; preds = %land.rhs25, %lor.end
  %20 = phi i1 [ false, %lor.end ], [ %cmp26, %land.rhs25 ]
  %conv28 = zext i1 %20 to i64
  call void @klee_assume(i64 %conv28)
  %call = call noalias i8* @malloc(i64 192) #5
  store i8* %call, i8** %base, align 8
  %21 = load i8*, i8** %base, align 8
  %cmp29 = icmp ne i8* %21, null
  %conv30 = zext i1 %cmp29 to i64
  call void @klee_assume(i64 %conv30)
  %22 = bitcast i32* %offset to i8*
  call void @klee_make_symbolic(i8* %22, i64 4, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.3, i64 0, i64 0))
  %23 = load i32, i32* %offset, align 4
  %cmp31 = icmp ult i32 %23, 32
  ...
  call void @klee_make_symbolic(i8* %26, i64 2, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.4, i64 0, i64 0))
...
cond.end:                                         ; preds = %cond.false, %cond.true
  %cond = phi i64 [ %29, %cond.true ], [ 16, %cond.false ]
...
if.end:                                           ; preds = %cond.end, %land.end27
  ...
  %arraydecay35 = getelementptr inbounds [3 x i64], [3 x i64]* %dims, i64 0, i64 0
  %33 = load i8*, i8** %data, align 8
  %34 = load i64, i64* %len, align 8
  %call36 = call %struct.TF_Tensor* @TF_NewTensor(i32 %32, i64* %arraydecay35, i32 2, i8* %33, i64 %34, void (i8*, i64, i8*)* @_ZL17dummy_deallocatorPvmS_, i8* null)
  store %struct.TF_Tensor* %call36, %struct.TF_Tensor** %t, align 8
  %35 = load %struct.TF_Tensor*, %struct.TF_Tensor** %t, align 8
  %cmp37 = icmp eq %struct.TF_Tensor* %35, null
  br i1 %cmp37, label %if.then38, label %if.end46

if.then38:                                        ; preds = %if.end
  %arrayidx39 = getelementptr inbounds [3 x i64], [3 x i64]* %dims, i64 0, i64 0
  %36 = load i64, i64* %arrayidx39, align 16
  %cmp40 = icmp eq i64 %36, 0
  br i1 %cmp40, label %if.then44, label %lor.lhs.false41

lor.lhs.false41:                                  ; preds = %if.then38
  %arrayidx42 = getelementptr inbounds [3 x i64], [3 x i64]* %dims, i64 0, i64 1

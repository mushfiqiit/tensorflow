...
entry:
  ...
  %arraydecay = getelementptr inbounds [3 x i64], [3 x i64]* %dims, i64 0, i64 0
  %0 = bitcast i64* %arraydecay to i8*
  call void @klee_make_symbolic(i8* %0, i64 24, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0))
  %arrayidx = getelementptr inbounds [3 x i64], [3 x i64]* %dims, i64 0, i64 0
  %1 = load i64, i64* %arrayidx, align 16
  %cmp = icmp sge i64 %1, -100
  br i1 %cmp, label %land.rhs, label %land.end

land.rhs:                                         ; preds = %entry
  %arrayidx1 = getelementptr inbounds [3 x i64], [3 x i64]* %dims, i64 0, i64 0
  %2 = load i64, i64* %arrayidx1, align 16
  %cmp2 = icmp sle i64 %2, 100
  br label %land.end
...
land.end:                                         ; preds = %land.rhs, %entry
  ...
  %arrayidx3 = getelementptr inbounds [3 x i64], [3 x i64]* %dims, i64 0, i64 1
  %4 = load i64, i64* %arrayidx3, align 8
  %cmp4 = icmp sge i64 %4, -100
  br i1 %cmp4, label %land.rhs5, label %land.end8

land.rhs5:                                        ; preds = %land.end
  %arrayidx6 = getelementptr inbounds [3 x i64], [3 x i64]* %dims, i64 0, i64 1
  %5 = load i64, i64* %arrayidx6, align 8
  %cmp7 = icmp sle i64 %5, 100
  br label %land.end8
...
land.end8:                                        ; preds = %land.rhs5, %land.end
  ...
  %arrayidx10 = getelementptr inbounds [3 x i64], [3 x i64]* %dims, i64 0, i64 2
  %7 = load i64, i64* %arrayidx10, align 16
  %cmp11 = icmp sge i64 %7, -100
  br i1 %cmp11, label %land.rhs12, label %land.end15

land.rhs12:                                       ; preds = %land.end8
  %arrayidx13 = getelementptr inbounds [3 x i64], [3 x i64]* %dims, i64 0, i64 2
  %8 = load i64, i64* %arrayidx13, align 16
  %cmp14 = icmp sle i64 %8, 100
  br label %land.end15

land.end15:                                       ; preds = %land.rhs12, %land.end8
  %9 = phi i1 [ false, %land.end8 ], [ %cmp14, %land.rhs12 ]
  %conv16 = zext i1 %9 to i64
  call void @klee_assume(i64 %conv16)
  %10 = bitcast i32* %dtype to i8*
  call void @klee_make_symbolic(i8* %10, i64 4, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0))
  %11 = load i32, i32* %dtype, align 4
  %cmp17 = icmp eq i32 %11, 1
  br i1 %cmp17, label %lor.end, label %lor.lhs.false

lor.lhs.false:                                    ; preds = %land.end15
...
lor.rhs:                                          ; preds = %lor.lhs.false27
  %18 = load i32, i32* %dtype, align 4
  %cmp29 = icmp eq i32 %18, 10
  br label %lor.end

lor.end:                                          ; preds = %lor.rhs, %lor.lhs.false27, %lor.lhs.false25, %lor.lhs.false23, %lor.lhs.false21, %lor.lhs.false19, %lor.lhs.false, %land.end15
  %19 = phi i1 [ true, %lor.lhs.false27 ], [ true, %lor.lhs.false25 ], [ true, %lor.lhs.false23 ], [ true, %lor.lhs.false21 ], [ true, %lor.lhs.false19 ], [ true, %lor.lhs.false ], [ true, %land.end15 ], [ %cmp29, %lor.rhs ]
  %conv30 = zext i1 %19 to i64
  call void @klee_assume(i64 %conv30)
  %20 = bitcast i64* %len to i8*
  call void @klee_make_symbolic(i8* %20, i64 8, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0))
  %21 = load i64, i64* %len, align 8
  %cmp31 = icmp ule i64 %21, 128
  br i1 %cmp31, label %land.rhs32, label %land.end34

land.rhs32:                                       ; preds = %lor.end
  %22 = load i64, i64* %len, align 8
  %cmp33 = icmp uge i64 %22, 0
  br label %land.end34

land.end34:                                       ; preds = %land.rhs32, %lor.end
  %23 = phi i1 [ false, %lor.end ], [ %cmp33, %land.rhs32 ]
  %conv35 = zext i1 %23 to i64
  call void @klee_assume(i64 %conv35)
  %call = call noalias i8* @malloc(i64 192) #5
  store i8* %call, i8** %base, align 8
  %24 = load i8*, i8** %base, align 8
  %cmp36 = icmp ne i8* %24, null
  %conv37 = zext i1 %cmp36 to i64
  call void @klee_assume(i64 %conv37)
  %25 = bitcast i32* %offset to i8*
  call void @klee_make_symbolic(i8* %25, i64 4, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.3, i64 0, i64 0))
  %26 = load i32, i32* %offset, align 4
  %cmp38 = icmp ult i32 %26, 32
  %conv39 = zext i1 %cmp38 to i64
  call void @klee_assume(i64 %conv39)
  ...
  call void @klee_make_symbolic(i8* %29, i64 8, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.4, i64 0, i64 0))
  %30 = load i32, i32* %dtype, align 4
  %arraydecay40 = getelementptr inbounds [3 x i64], [3 x i64]* %dims, i64 0, i64 0
  %31 = load i8*, i8** %data, align 8
  %32 = load i64, i64* %len, align 8
  %call41 = call %struct.TF_Tensor* @TF_NewTensor(i32 %30, i64* %arraydecay40, i32 2, i8* %31, i64 %32, void (i8*, i64, i8*)* @_ZL17dummy_deallocatorPvmS_, i8* null)
  store %struct.TF_Tensor* %call41, %struct.TF_Tensor** %t, align 8
  %33 = load %struct.TF_Tensor*, %struct.TF_Tensor** %t, align 8
  %cmp42 = icmp eq %struct.TF_Tensor* %33, null
  br i1 %cmp42, label %if.then, label %if.end49

if.then:                                          ; preds = %land.end34
  %arrayidx43 = getelementptr inbounds [3 x i64], [3 x i64]* %dims, i64 0, i64 0
  %34 = load i64, i64* %arrayidx43, align 16
  %cmp44 = icmp eq i64 %34, 0
  br i1 %cmp44, label %if.then48, label %lor.lhs.false45

lor.lhs.false45:                                  ; preds = %if.then
  %arrayidx46 = getelementptr inbounds [3 x i64], [3 x i64]* %dims, i64 0, i64 1
  %35 = load i64, i64* %arrayidx46, align 8
  %cmp47 = icmp eq i64 %35, 0
  br i1 %cmp47, label %if.then48, label %if.else

if.then48:                                        ; preds = %lor.lhs.false45, %if.then
  br label %if.end
...
if.end49:                                         ; preds = %land.end34
  %36 = load %struct.TF_Tensor*, %struct.TF_Tensor** %t, align 8
  call void @TF_DeleteTensor(%struct.TF_Tensor* %36)
  %37 = load i8*, i8** %base, align 8
...
if.then:                                          ; preds = %entry
  call void @_ZSt20__throw_length_errorPKc(i8* getelementptr inbounds ([49 x i8], [49 x i8]* @.str.5.6, i64 0, i64 0)) #19
  unreachable
...
if.then:                                          ; preds = %entry
  call void @klee_report_error(i8* getelementptr inbounds ([67 x i8], [67 x i8]* @.str.9, i64 0, i64 0), i32 14, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.1.10, i64 0, i64 0), i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.2.11, i64 0, i64 0)) #19, !dbg !136
  unreachable, !dbg !136
